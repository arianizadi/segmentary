...
let records=[],selected=cases[0]?.case_key||null,blinded=true,selectedModels=new Set(models.map(m=>m.id)),dirty=false,everRevealed=false,loadedReviewer='',loadedScope='';
