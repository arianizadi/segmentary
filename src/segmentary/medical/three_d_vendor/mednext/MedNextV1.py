...
from .blocks import MedNeXtBlock, MedNeXtDownBlock, MedNeXtUpBlock, OutBlock
...
class MedNeXt(nn.Module):
    def __init__(
        ...
        checkpoint_style: str | None = None,  # Either inside block or outside block
        ...
        # Modern non-reentrant checkpointing does not need a trainable dummy.
        self.register_buffer("dummy_tensor", torch.tensor([1.0]))
        ...
        if self.outside_block_checkpointing:
            ...
            if self.do_ds:
                x_ds_4 = checkpoint.checkpoint(
                    self.out_4, x, self.dummy_tensor, use_reentrant=False
                )
            ...
            if self.do_ds:
                x_ds_3 = checkpoint.checkpoint(
                    self.out_3, x, self.dummy_tensor, use_reentrant=False
                )
            del x_res_3, x_up_3
            ...
            if self.do_ds:
                x_ds_2 = checkpoint.checkpoint(
                    self.out_2, x, self.dummy_tensor, use_reentrant=False
                )
            del x_res_2, x_up_2
            ...
            if self.do_ds:
                x_ds_1 = checkpoint.checkpoint(
                    self.out_1, x, self.dummy_tensor, use_reentrant=False
                )
            del x_res_1, x_up_1
