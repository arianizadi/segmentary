...
Model-declared decoder/head groups can use a different stage scale:
...
parameters as well as the reset classifier. The shipped
[`city_checkpoint_rs.yaml`](../../configs/campaigns/city_checkpoint_rs.yaml)
recipe uses this contract for one 20,000-iteration RailSem19 adaptation after
the reused 40,000-iteration Cityscapes checkpoint, for 60,000 cumulative
