...
> the decoder and segmentation classifier are random. This is not model-quality
> evidence.
...
|---|---:|---:|
| PyTorch FP32 | 5.582 | 6.247 |
| ONNX Runtime FP32 | 6.669 | 6.809 |
| TensorRT FP16 | 0.982 | 1.009 |
| TensorRT mixed INT8 | 0.773 | 0.792 |

Every backend returned finite `1×19×256×512` logits on a real validation image.
The FP16 engine had 146 inspected FP16 layers. The mixed INT8
