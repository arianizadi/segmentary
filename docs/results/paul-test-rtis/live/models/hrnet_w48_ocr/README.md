...
| hrnet_w48_ocr | railsem19_to_rtis | 2 | completed | 4000 | 3818 | 3.80 | 6.10 | 9.16 | 5.71 | 43.89 | 51.20 |
...
| hrnet_w48_ocr | cityscapes_to_railsem19_to_rtis | 2 | completed | 3818 | 2545 | 3.66 | 12.22 | 4.97 | 2.25 | 39.99 | 46.66 |
...
| Best full-state checkpoint (MiB) | 1119.23 |
| Final full-state checkpoint (MiB) | 1119.18 |
| Verified periodic checkpoints removed (GiB) | 8.74 |
...
Status: **completed**. Started: 2026-09-06T15:17:39.999606+00:00. Finished: 2026-09-06T17:14:15.931558+00:00.
...
Config SHA-256: `5a75cacae516ea49054a33c90f8673f7636da41babfe75d4da801485b1579098`. Weights used for validation: `raw`.
...
| --- | --- | --- |
| Mud IoU | 3.80 | 5.71 |
| Mud precision | 6.10 | 11.07 |
| Mud recall | 9.16 | 10.54 |
| Mud Dice/F1 | 7.32 | 10.80 |
| mIoU | 43.89 | 42.56 |
| Mean accuracy | 59.19 | 57.50 |
| Mean precision | 62.07 | 61.62 |
| Mean Dice | 53.91 | 52.81 |
| Mean specificity | 99.12 | 99.11 |
| Pixel accuracy | 85.91 | 85.83 |
| Frequency-weighted IoU | 77.72 | 77.32 |
| Fixed GT-present class mIoU | 51.20 | 49.66 |
| Boundary F1 | 50.83 | 49.99 |
...
| Peak training VRAM, retained training invocation (GiB) | 17.35 |
| Peak evaluation VRAM (GiB) | 7.58 |
| Retained training invocation wall time (seconds) | 6777.19 |
| Retained training invocation GPU-hours (one GPU) | 1.88 |
| Evaluation wall time (seconds) | 18.82 |
| Full evaluation pipeline images/second | 1.97 |
| Best full-state checkpoint (MiB) | 1119.23 |
| Final full-state checkpoint (MiB) | 1119.18 |
| Verified periodic checkpoints removed (GiB) | 8.74 |
...
| Status | Parameters | Weight MiB | FPS | p50 ms | p95 ms | Peak reserved GiB |
| --- | --- | --- | --- | --- | --- | --- |
| complete | 73168490 | 279.12 | 30.61 | 32.26 | 33.93 | 1.26 |

```json
{
  "schema_version": 1,
  "model_id": "hrnet_w48_ocr",
  "measured_at": "2026-09-06T17:14:04+00:00",
  "status": "complete",
  "benchmark_scope": "rtis_selected_checkpoint_model_only",
  "applies_to": [
    "hrnet_w48_ocr--railsem19_to_rtis--seed-2"
  ],
  "source": {
    "campaign_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "git_dirty": false,
    "config_hash": "026c90b6b3e6",
    "resolved_config": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/configs/hrnet_w48_ocr--railsem19_to_rtis--seed-2.yaml",
    "config_sha256": "5a75cacae516ea49054a33c90f8673f7636da41babfe75d4da801485b1579098",
    "checkpoint_sha256": "2e5c399e9c94f3035e60dac4dd97b177aff47d05cff8d7aa663048ce4a46af62",
    "checkpoint_global_step": 3818,
    "checkpoint_bytes": 1173602878,
    "checkpoint_kind": "resume checkpoint with optimizer and EMA state",
    "weights": "raw",
    "measured_checkpoint_job_id": "hrnet_w48_ocr--railsem19_to_rtis--seed-2",
    "result_sha256": "3809025a779b3e54ee722f742e693b790ec6ea2f257958723fe7fe5d534c472e",
    "result_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "result_stage": "eval:paul-test-rtis:val",
    "result_seed": 2
  },
  ...
  "measurements": {
    "latency": {
      "p50_ms": 32.2620964050293,
      "p95_ms": 33.93464469909668,
      "mean_ms": 32.67197254180908,
      "minimum_ms": 31.924192428588867,
      "maximum_ms": 39.042049407958984,
      "fps": 30.60727351923236,
      "raw_ms": [
        32.19247817993164,
        32.700416564941406,
        32.20479965209961,
    ...
    "peak_reserved_bytes": 1350565888,
    "memory_kind": "pytorch_cuda_allocator_peak_reserved_excluding_context",
    "benchmark_wall_clock_s": 16.69845237955451
  },
  "started_at": "2026-09-06T17:13:47+00:00",
  "finished_at": "2026-09-06T17:14:04+00:00",
  "environment": {
    "hostname": "hdrfs-app-001",
    "python": "3.11.15",
    "platform": "Linux-5.15.0-139-generic-x86_64-with-glibc2.35",
...
| Class | GT pixels | IoU (%) | Precision (%) | Recall (%) | Dice (%) | Boundary F1 (%) |
| --- | --- | --- | --- | --- | --- | --- |
| car | 29664 | 66.40 | 79.07 | 80.55 | 79.80 | 59.08 |
| construction | 311585 | 60.39 | 71.26 | 79.84 | 75.31 | 70.08 |
| fence | 265137 | 24.79 | 89.62 | 25.52 | 39.73 | 46.83 |
| mud-pumping | 1226250 | 3.80 | 6.10 | 9.16 | 7.32 | 4.03 |
| on-rails | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| person | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| pole | 628038 | 77.49 | 88.54 | 86.13 | 87.32 | 92.75 |
| rail-embedded | 16799 | 42.47 | 85.33 | 45.82 | 59.62 | 81.72 |
| rail-raised | 2969797 | 73.39 | 78.20 | 92.27 | 84.66 | 86.70 |
| rail-track | 6323197 | 43.62 | 68.64 | 54.47 | 60.74 | 57.65 |
| road | 1048831 | 9.48 | 42.78 | 10.85 | 17.31 | 22.51 |
| sidewalk | 1297367 | 50.73 | 94.92 | 52.14 | 67.31 | 20.93 |
| sky | 19121606 | 98.37 | 99.46 | 98.89 | 99.18 | 94.43 |
| standing-water | 95802 | 0.87 | 1.04 | 5.15 | 1.73 | 5.52 |
| terrain | 39239306 | 88.02 | 90.11 | 97.44 | 93.63 | 65.06 |
| trackbed | 10643081 | 65.59 | 76.45 | 82.21 | 79.22 | 60.67 |
| traffic-light | 19510 | 54.05 | 86.23 | 59.16 | 70.17 | 82.90 |
| traffic-sign | 13285 | 57.98 | 86.78 | 63.60 | 73.40 | 83.51 |
| tram-track | 56179 | 62.91 | 78.08 | 76.40 | 77.23 | 61.74 |
| truck | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| vegetation-overgrowth | 5901821 | 41.29 | 80.89 | 45.76 | 58.45 | 71.35 |

### Full-run accounting

| Measurement | Value |
| --- | --- |
| Full GPU-reserved wall seconds, all recorded worker attempts | 6996.81 |
...
| Checkpoint / weights / split | Images | Mud IoU (%) | Mud precision (%) | Mud recall (%) |
| --- | --- | --- | --- | --- |
| best-auto-train / raw | 220 | 95.34 | 97.70 | 97.53 |
| best-auto-val / raw | 37 | 3.80 | 6.10 | 9.16 |
| best-alternate-val / ema | 37 | 3.11 | 5.30 | 6.99 |
| final-auto-val / raw | 37 | 5.70 | 11.06 | 10.52 |
...
```json
{
  ...
  "checkpoints": {
    "best": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/hrnet_w48_ocr--railsem19_to_rtis--seed-2_seed2/rtis/best.ckpt",
      "sha256": "2e5c399e9c94f3035e60dac4dd97b177aff47d05cff8d7aa663048ce4a46af62",
      "global_step": 3818,
      "bytes": 1173602878
    },
    "final": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/hrnet_w48_ocr--railsem19_to_rtis--seed-2_seed2/rtis/last.ckpt",
      "sha256": "b17a09bc5e66c388dfe55453f3b031b9bdae0bf067c1ced0f515658a4281d321",
      "global_step": 4000,
      "bytes": 1173541438
    }
  },
...
Status: **completed**. Started: 2026-09-06T16:04:53.931337+00:00. Finished: 2026-09-06T17:57:29.750558+00:00.
...
Config SHA-256: `a095d0f0e305649d2db223ed760a1f242d057ba45a94d64f1b98c66fe48c1fb7`. Weights used for validation: `raw`.
...
| --- | --- | --- |
| Mud IoU | 3.66 | 2.25 |
| Mud precision | 12.22 | 7.28 |
| Mud recall | 4.97 | 3.16 |
| Mud Dice/F1 | 7.07 | 4.41 |
| mIoU | 39.99 | 41.11 |
| Mean accuracy | 53.50 | 52.93 |
| Mean precision | 64.02 | 65.82 |
| Mean Dice | 49.68 | 50.30 |
| Mean specificity | 98.89 | 98.80 |
| Pixel accuracy | 83.50 | 82.51 |
| Frequency-weighted IoU | 72.80 | 71.18 |
| Fixed GT-present class mIoU | 46.66 | 45.68 |
| Boundary F1 | 47.21 | 47.56 |
...
| Peak training VRAM, retained training invocation (GiB) | 17.35 |
| Peak evaluation VRAM (GiB) | 7.58 |
| Retained training invocation wall time (seconds) | 6534.39 |
| Retained training invocation GPU-hours (one GPU) | 1.82 |
| Evaluation wall time (seconds) | 19.09 |
| Full evaluation pipeline images/second | 1.94 |
| Best full-state checkpoint (MiB) | 1119.23 |
| Final full-state checkpoint (MiB) | 1119.18 |
| Verified periodic checkpoints removed (GiB) | 7.65 |
...
| Status | Parameters | Weight MiB | FPS | p50 ms | p95 ms | Peak reserved GiB |
| --- | --- | --- | --- | --- | --- | --- |
| complete | 73168490 | 279.12 | 29.47 | 33.78 | 35.43 | 1.26 |

```json
{
  "schema_version": 1,
  "model_id": "hrnet_w48_ocr",
  "measured_at": "2026-09-06T17:57:19+00:00",
  "status": "complete",
  "benchmark_scope": "rtis_selected_checkpoint_model_only",
  "applies_to": [
    "hrnet_w48_ocr--cityscapes_to_railsem19_to_rtis--seed-2"
  ],
  "source": {
    "campaign_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "git_dirty": false,
    "config_hash": "9b52388b991f",
    "resolved_config": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/configs/hrnet_w48_ocr--cityscapes_to_railsem19_to_rtis--seed-2.yaml",
    "config_sha256": "a095d0f0e305649d2db223ed760a1f242d057ba45a94d64f1b98c66fe48c1fb7",
    "checkpoint_sha256": "a58d641a3bd728c353ac376ef890d41a4bf9272140e03a79d58a400d31a0c3fe",
    "checkpoint_global_step": 2545,
    "checkpoint_bytes": 1173602878,
    "checkpoint_kind": "resume checkpoint with optimizer and EMA state",
    "weights": "raw",
    "measured_checkpoint_job_id": "hrnet_w48_ocr--cityscapes_to_railsem19_to_rtis--seed-2",
    "result_sha256": "c5d2da4d1f4c17c090d33d70bbe932c2df03a58a4fa25c00edc81e493c0f82dc",
    "result_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "result_stage": "eval:paul-test-rtis:val",
    "result_seed": 2
  },
  ...
  "measurements": {
    "latency": {
      "p50_ms": 33.77971267700195,
      "p95_ms": 35.43091354370117,
      "mean_ms": 33.93366233825684,
      "minimum_ms": 32.875518798828125,
      "maximum_ms": 37.34016036987305,
      "fps": 29.4692624106358,
      "raw_ms": [
        37.34016036987305,
        33.81145477294922,
        33.26051330566406,
    ...
    "peak_reserved_bytes": 1350565888,
    "memory_kind": "pytorch_cuda_allocator_peak_reserved_excluding_context",
    "benchmark_wall_clock_s": 16.85480297729373
  },
  "started_at": "2026-09-06T17:57:02+00:00",
  "finished_at": "2026-09-06T17:57:19+00:00",
  "environment": {
    "hostname": "hdrfs-app-001",
    "python": "3.11.15",
    "platform": "Linux-5.15.0-139-generic-x86_64-with-glibc2.35",
...
| Class | GT pixels | IoU (%) | Precision (%) | Recall (%) | Dice (%) | Boundary F1 (%) |
| --- | --- | --- | --- | --- | --- | --- |
| car | 29664 | 79.00 | 85.39 | 91.35 | 88.27 | 82.31 |
| construction | 311585 | 62.23 | 72.28 | 81.73 | 76.72 | 69.90 |
| fence | 265137 | 13.65 | 84.03 | 14.01 | 24.02 | 34.22 |
| mud-pumping | 1226250 | 3.66 | 12.22 | 4.97 | 7.07 | 4.94 |
| on-rails | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| person | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| pole | 628038 | 77.58 | 86.94 | 87.81 | 87.37 | 92.76 |
| rail-embedded | 16799 | 19.60 | 92.38 | 19.92 | 32.78 | 35.85 |
| rail-raised | 2969797 | 72.10 | 77.44 | 91.26 | 83.79 | 86.70 |
| rail-track | 6323197 | 41.14 | 57.29 | 59.34 | 58.30 | 53.70 |
| road | 1048831 | 21.54 | 61.35 | 24.92 | 35.44 | 21.93 |
| sidewalk | 1297367 | 37.84 | 88.59 | 39.78 | 54.91 | 13.90 |
| sky | 19121606 | 98.83 | 99.37 | 99.45 | 99.41 | 96.86 |
| standing-water | 95802 | 0.45 | 3.27 | 0.52 | 0.90 | 3.55 |
| terrain | 39239306 | 84.21 | 85.08 | 98.80 | 91.43 | 55.53 |
| trackbed | 10643081 | 55.60 | 70.92 | 72.01 | 71.46 | 51.90 |
| traffic-light | 19510 | 54.46 | 93.20 | 56.71 | 70.51 | 88.92 |
| traffic-sign | 13285 | 53.94 | 95.64 | 55.30 | 70.08 | 76.63 |
| tram-track | 56179 | 50.61 | 97.66 | 51.23 | 67.21 | 69.58 |
| truck | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| vegetation-overgrowth | 5901821 | 13.42 | 81.28 | 13.85 | 23.66 | 52.29 |

### Full-run accounting

| Measurement | Value |
| --- | --- |
| Full GPU-reserved wall seconds, all recorded worker attempts | 6756.63 |
| Full reserved GPU-hours | 1.88 |
| Whole-run timing complete | True |
...
| Checkpoint / weights / split | Images | Mud IoU (%) | Mud precision (%) | Mud recall (%) |
| --- | --- | --- | --- | --- |
| best-auto-train / raw | 220 | 92.66 | 95.99 | 96.39 |
| best-auto-val / raw | 37 | 3.66 | 12.22 | 4.97 |
| best-alternate-val / ema | 37 | 4.65 | 10.71 | 7.59 |
| final-auto-val / raw | 37 | 2.25 | 7.28 | 3.16 |
...
```json
{
  ...
  "checkpoints": {
    "best": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/hrnet_w48_ocr--cityscapes_to_railsem19_to_rtis--seed-2_seed2/rtis/best.ckpt",
      "sha256": "a58d641a3bd728c353ac376ef890d41a4bf9272140e03a79d58a400d31a0c3fe",
      "global_step": 2545,
      "bytes": 1173602878
    },
    "final": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/hrnet_w48_ocr--cityscapes_to_railsem19_to_rtis--seed-2_seed2/rtis/last.ckpt",
      "sha256": "7c3485d99a0026094757249cc93d7f901749b7a7ead245b85afe59541cb4974c",
      "global_step": 3818,
      "bytes": 1173541630
    }
  },
