...
| smp_deeplabv3plus_resnet101 | cityscapes_to_railsem19_to_rtis | 1 | completed | 4000 | 2800 | 6.23 | 12.66 | 10.92 | 5.22 | 41.20 | 45.77 |
| smp_deeplabv3plus_resnet101 | cityscapes_to_railsem19_to_rtis | 2 | completed | 2800 | 1527 | 6.10 | 8.85 | 16.40 | 2.64 | 41.59 | 46.21 |
...
| Best full-state checkpoint (MiB) | 698.52 |
| Final full-state checkpoint (MiB) | 698.50 |
| Verified periodic checkpoints removed (GiB) | 4.09 |
...
Status: **completed**. Started: 2026-09-07T06:13:53.384007+00:00. Finished: 2026-09-07T07:04:55.565424+00:00.
...
Config SHA-256: `b53371229723a103f7c00cd4ded80d31b8c31ac372df5184cf5bcda6fb96b74c`. Weights used for validation: `raw`.
...
| --- | --- | --- |
| Mud IoU | 6.23 | 5.22 |
| Mud precision | 12.66 | 10.29 |
| Mud recall | 10.92 | 9.58 |
| Mud Dice/F1 | 11.73 | 9.92 |
| mIoU | 41.20 | 40.53 |
| Mean accuracy | 55.90 | 54.52 |
| Mean precision | 59.67 | 59.57 |
| Mean Dice | 51.57 | 50.98 |
| Mean specificity | 98.95 | 98.91 |
| Pixel accuracy | 83.31 | 82.88 |
| Frequency-weighted IoU | 73.56 | 72.95 |
| Fixed GT-present class mIoU | 45.77 | 45.03 |
| Boundary F1 | 47.18 | 46.40 |
...
| Peak training VRAM, retained training invocation (GiB) | 10.08 |
| Peak evaluation VRAM (GiB) | 7.19 |
| Retained training invocation wall time (seconds) | 2918.13 |
| Retained training invocation GPU-hours (one GPU) | 0.81 |
| Evaluation wall time (seconds) | 12.39 |
...
| Status | Parameters | Weight MiB | FPS | p50 ms | p95 ms | Peak reserved GiB |
| --- | --- | --- | --- | --- | --- | --- |
| complete | 45674853 | 174.24 | 100.34 | 9.24 | 13.53 | 0.71 |

```json
{
  "schema_version": 1,
  "model_id": "smp_deeplabv3plus_resnet101",
  "measured_at": "2026-09-07T07:04:47+00:00",
  "status": "complete",
  "benchmark_scope": "rtis_selected_checkpoint_model_only",
  "applies_to": [
    "smp_deeplabv3plus_resnet101--cityscapes_to_railsem19_to_rtis--seed-1"
  ],
  "source": {
    "campaign_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "git_dirty": false,
    "config_hash": "98a51a6ce71f",
    "resolved_config": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/configs/smp_deeplabv3plus_resnet101--cityscapes_to_railsem19_to_rtis--seed-1.yaml",
    "config_sha256": "b53371229723a103f7c00cd4ded80d31b8c31ac372df5184cf5bcda6fb96b74c",
    "checkpoint_sha256": "6434b3ad14d355dd135449672a657795add21ee9b0e37d0ca2ff887f0b3f0cc7",
    "checkpoint_global_step": 2800,
    "checkpoint_bytes": 732454188,
    "checkpoint_kind": "resume checkpoint with optimizer and EMA state",
    "weights": "raw",
    "measured_checkpoint_job_id": "smp_deeplabv3plus_resnet101--cityscapes_to_railsem19_to_rtis--seed-1",
    "result_sha256": "78cd82f67a8cd1a5a5ec242466eaf78144a4821ef4f59b9a118d922c6654f8ff",
    "result_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "result_stage": "eval:paul-test-rtis:val",
    "result_seed": 1
  },
  ...
  "measurements": {
    "latency": {
      "p50_ms": 9.236976146697998,
      "p95_ms": 13.531894350051878,
      "mean_ms": 9.966089582443237,
      "minimum_ms": 8.563712120056152,
      "maximum_ms": 16.18329620361328,
      "fps": 100.34025800466917,
      "raw_ms": [
        16.18329620361328,
        11.04691219329834,
        9.161727905273438,
    ...
    "peak_reserved_bytes": 763363328,
    "memory_kind": "pytorch_cuda_allocator_peak_reserved_excluding_context",
    "benchmark_wall_clock_s": 13.082566898316145
  },
  "started_at": "2026-09-07T07:04:33+00:00",
  "finished_at": "2026-09-07T07:04:47+00:00",
  "environment": {
    "hostname": "hdrfs-app-001",
    "python": "3.11.15",
    "platform": "Linux-5.15.0-139-generic-x86_64-with-glibc2.35",
...
| Class | GT pixels | IoU (%) | Precision (%) | Recall (%) | Dice (%) | Boundary F1 (%) |
| --- | --- | --- | --- | --- | --- | --- |
| car | 29664 | 70.85 | 80.94 | 85.03 | 82.94 | 74.66 |
| construction | 311585 | 48.95 | 55.10 | 81.43 | 65.73 | 53.90 |
| fence | 265137 | 15.25 | 21.42 | 34.61 | 26.46 | 19.35 |
| mud-pumping | 1226250 | 6.23 | 12.66 | 10.92 | 11.73 | 7.27 |
| on-rails | 0 | — | — | — | — | — |
| person | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| pole | 628038 | 75.85 | 86.15 | 86.38 | 86.27 | 91.90 |
| rail-embedded | 16799 | 30.24 | 80.93 | 32.56 | 46.44 | 53.89 |
| rail-raised | 2969797 | 72.04 | 85.58 | 82.00 | 83.75 | 92.04 |
| rail-track | 6323197 | 34.86 | 61.59 | 44.55 | 51.70 | 44.16 |
| road | 1048831 | 28.81 | 48.93 | 41.20 | 44.73 | 27.73 |
| sidewalk | 1297367 | 32.77 | 67.87 | 38.79 | 49.37 | 9.08 |
| sky | 19121606 | 98.77 | 99.22 | 99.55 | 99.38 | 97.07 |
| standing-water | 95802 | 0.53 | 3.06 | 0.64 | 1.06 | 3.65 |
| terrain | 39239306 | 87.53 | 88.86 | 98.32 | 93.35 | 65.65 |
| trackbed | 10643081 | 54.20 | 61.84 | 81.43 | 70.30 | 50.96 |
| traffic-light | 19510 | 77.93 | 86.10 | 89.15 | 87.60 | 82.31 |
| traffic-sign | 13285 | 50.86 | 76.52 | 60.26 | 67.43 | 66.26 |
| tram-track | 56179 | 25.70 | 89.08 | 26.53 | 40.89 | 58.71 |
| truck | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| vegetation-overgrowth | 5901821 | 12.55 | 87.59 | 12.78 | 22.31 | 45.02 |

### Full-run accounting

| Measurement | Value |
| --- | --- |
| Full GPU-reserved wall seconds, all recorded worker attempts | 3062.75 |
...
| Checkpoint / weights / split | Images | Mud IoU (%) | Mud precision (%) | Mud recall (%) |
| --- | --- | --- | --- | --- |
| best-auto-train / raw | 220 | 93.86 | 96.36 | 97.31 |
| best-auto-val / raw | 37 | 6.23 | 12.66 | 10.92 |
| best-alternate-val / ema | 37 | 2.94 | 18.06 | 3.39 |
| final-auto-val / raw | 37 | 5.21 | 10.28 | 9.57 |
...
```json
{
  ...
  "checkpoints": {
    "best": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/smp_deeplabv3plus_resnet101--cityscapes_to_railsem19_to_rtis--seed-1_seed1/rtis/best.ckpt",
      "sha256": "6434b3ad14d355dd135449672a657795add21ee9b0e37d0ca2ff887f0b3f0cc7",
      "global_step": 2800,
      "bytes": 732454188
    },
    "final": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/smp_deeplabv3plus_resnet101--cityscapes_to_railsem19_to_rtis--seed-1_seed1/rtis/last.ckpt",
      "sha256": "f07f264609d71b09e5516325f0f0bf6acf5b5b28313b8ac98e70b2795ab19b43",
      "global_step": 4000,
      "bytes": 732431852
    }
  },
...
Status: **completed**. Started: 2026-09-07T06:23:35.412548+00:00. Finished: 2026-09-07T06:59:23.941337+00:00.
...
Config SHA-256: `2da210858b3392294fc8fa5347aa684dc58696aa6e38c96f105fff29225d64de`. Weights used for validation: `raw`.
...
| --- | --- | --- |
| Mud IoU | 6.10 | 2.64 |
| Mud precision | 8.85 | 4.66 |
| Mud recall | 16.40 | 5.75 |
| Mud Dice/F1 | 11.49 | 5.15 |
| mIoU | 41.59 | 41.10 |
| Mean accuracy | 56.48 | 57.16 |
| Mean precision | 59.10 | 56.66 |
| Mean Dice | 51.95 | 51.17 |
| Mean specificity | 98.90 | 98.90 |
| Pixel accuracy | 82.68 | 82.73 |
| Frequency-weighted IoU | 72.87 | 73.03 |
| Fixed GT-present class mIoU | 46.21 | 45.67 |
| Boundary F1 | 46.85 | 46.22 |
...
| Peak training VRAM, retained training invocation (GiB) | 10.08 |
| Peak evaluation VRAM (GiB) | 7.19 |
| Retained training invocation wall time (seconds) | 2007.88 |
...
| Status | Parameters | Weight MiB | FPS | p50 ms | p95 ms | Peak reserved GiB |
| --- | --- | --- | --- | --- | --- | --- |
| complete | 45674853 | 174.24 | 107.77 | 9.04 | 10.67 | 0.66 |

```json
{
  "schema_version": 1,
  "model_id": "smp_deeplabv3plus_resnet101",
  "measured_at": "2026-09-07T06:59:17+00:00",
  "status": "complete",
  "benchmark_scope": "rtis_selected_checkpoint_model_only",
  "applies_to": [
    "smp_deeplabv3plus_resnet101--cityscapes_to_railsem19_to_rtis--seed-2"
  ],
  "source": {
    "campaign_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "git_dirty": false,
    "config_hash": "c96be98150cd",
    "resolved_config": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/configs/smp_deeplabv3plus_resnet101--cityscapes_to_railsem19_to_rtis--seed-2.yaml",
    "config_sha256": "2da210858b3392294fc8fa5347aa684dc58696aa6e38c96f105fff29225d64de",
    "checkpoint_sha256": "afb23d6b0687e41923b1d129f492a428153f416cc8ad80720dd18b533ec82250",
    "checkpoint_global_step": 1527,
    "checkpoint_bytes": 732454188,
    "checkpoint_kind": "resume checkpoint with optimizer and EMA state",
    "weights": "raw",
    "measured_checkpoint_job_id": "smp_deeplabv3plus_resnet101--cityscapes_to_railsem19_to_rtis--seed-2",
    "result_sha256": "64e293cee952414647886a47fc1806d71049c9fd374814ad8fcb9660b0e8cc6d",
    "result_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "result_stage": "eval:paul-test-rtis:val",
    "result_seed": 2
  },
  ...
  "measurements": {
    "latency": {
      "p50_ms": 9.03932809829712,
      "p95_ms": 10.670387649536131,
      "mean_ms": 9.27931586265564,
      "minimum_ms": 8.328191757202148,
      "maximum_ms": 13.017087936401367,
      "fps": 107.76656542369395,
      "raw_ms": [
        8.8340482711792,
        9.348095893859863,
        8.769599914550781,
    ...
    "peak_reserved_bytes": 704643072,
    "memory_kind": "pytorch_cuda_allocator_peak_reserved_excluding_context",
    "benchmark_wall_clock_s": 12.433236569166183
  },
  "started_at": "2026-09-07T06:59:05+00:00",
  "finished_at": "2026-09-07T06:59:17+00:00",
  "environment": {
    "hostname": "hdrfs-app-001",
    "python": "3.11.15",
    "platform": "Linux-5.15.0-139-generic-x86_64-with-glibc2.35",
...
| Class | GT pixels | IoU (%) | Precision (%) | Recall (%) | Dice (%) | Boundary F1 (%) |
| --- | --- | --- | --- | --- | --- | --- |
| car | 29664 | 68.02 | 79.75 | 82.22 | 80.97 | 69.75 |
| construction | 311585 | 52.60 | 60.16 | 80.71 | 68.94 | 49.38 |
| fence | 265137 | 19.54 | 25.23 | 46.43 | 32.69 | 22.46 |
| mud-pumping | 1226250 | 6.10 | 8.85 | 16.40 | 11.49 | 10.37 |
| on-rails | 0 | — | — | — | — | — |
| person | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| pole | 628038 | 75.18 | 84.92 | 86.77 | 85.83 | 91.18 |
| rail-embedded | 16799 | 26.81 | 73.00 | 29.76 | 42.28 | 62.00 |
| rail-raised | 2969797 | 74.39 | 87.10 | 83.60 | 85.32 | 93.12 |
| rail-track | 6323197 | 34.36 | 73.80 | 39.14 | 51.15 | 41.45 |
| road | 1048831 | 15.65 | 33.23 | 22.83 | 27.07 | 20.04 |
| sidewalk | 1297367 | 31.29 | 62.29 | 38.60 | 47.66 | 10.72 |
| sky | 19121606 | 97.25 | 99.61 | 97.61 | 98.60 | 87.90 |
| standing-water | 95802 | 0.00 | 0.00 | 0.00 | 0.00 | 0.98 |
| terrain | 39239306 | 86.13 | 87.31 | 98.46 | 92.55 | 60.54 |
| trackbed | 10643081 | 55.84 | 64.03 | 81.36 | 71.66 | 51.11 |
| traffic-light | 19510 | 77.86 | 81.68 | 94.34 | 87.55 | 80.44 |
| traffic-sign | 13285 | 53.01 | 90.70 | 56.06 | 69.29 | 73.51 |
| tram-track | 56179 | 42.89 | 82.82 | 47.08 | 60.03 | 65.20 |
| truck | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| vegetation-overgrowth | 5901821 | 14.89 | 87.56 | 15.21 | 25.92 | 46.87 |

### Full-run accounting

| Measurement | Value |
| --- | --- |
| Full GPU-reserved wall seconds, all recorded worker attempts | 2149.05 |
...
| Checkpoint / weights / split | Images | Mud IoU (%) | Mud precision (%) | Mud recall (%) |
| --- | --- | --- | --- | --- |
| best-auto-train / raw | 220 | 91.05 | 92.83 | 97.93 |
| best-auto-val / raw | 37 | 6.10 | 8.85 | 16.40 |
| best-alternate-val / ema | 37 | 1.21 | 4.37 | 1.65 |
| final-auto-val / raw | 37 | 2.64 | 4.65 | 5.75 |
...
```json
{
  ...
  "checkpoints": {
    "best": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/smp_deeplabv3plus_resnet101--cityscapes_to_railsem19_to_rtis--seed-2_seed2/rtis/best.ckpt",
      "sha256": "afb23d6b0687e41923b1d129f492a428153f416cc8ad80720dd18b533ec82250",
      "global_step": 1527,
      "bytes": 732454188
    },
    "final": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/smp_deeplabv3plus_resnet101--cityscapes_to_railsem19_to_rtis--seed-2_seed2/rtis/last.ckpt",
      "sha256": "c84efc7b574ad70e43c85133aa8fcd3110d5f9c02288619aa36d21126f29c857",
      "global_step": 2800,
      "bytes": 732431980
    }
  },
