...
| native_convnext_tiny_channelmapper_dpt | railsem19_to_rtis | 2 | completed | 3309 | 2036 | 1.99 | 5.73 | 2.96 | 1.88 | 41.38 | 45.97 |
...
| native_convnext_tiny_channelmapper_dpt | cityscapes_to_railsem19_to_rtis | 1 | completed | 2290 | 1018 | 2.24 | 3.89 | 5.02 | 1.65 | 41.69 | 48.64 |
| native_convnext_tiny_channelmapper_dpt | cityscapes_to_railsem19_to_rtis | 2 | completed | 2036 | 1781 | 2.25 | 5.22 | 3.82 | 2.08 | 44.37 | 49.30 |
...
| Best full-state checkpoint (MiB) | 583.74 |
| Final full-state checkpoint (MiB) | 583.73 |
| Verified periodic checkpoints removed (GiB) | 3.42 |
...
Status: **completed**. Started: 2026-09-06T17:14:16.377387+00:00. Finished: 2026-09-06T18:47:36.758915+00:00.
...
Config SHA-256: `b11d6c0d44d7c5bc9431c7ab24596f537f48aa81248a61dd69abf32bd401b0e5`. Weights used for validation: `ema`.
...
| --- | --- | --- |
| Mud IoU | 1.99 | 1.88 |
| Mud precision | 5.73 | 5.47 |
| Mud recall | 2.96 | 2.79 |
| Mud Dice/F1 | 3.91 | 3.69 |
| mIoU | 41.38 | 41.51 |
| Mean accuracy | 57.74 | 57.72 |
| Mean precision | 56.62 | 56.86 |
| Mean Dice | 52.31 | 52.47 |
| Mean specificity | 99.08 | 99.07 |
| Pixel accuracy | 85.55 | 85.50 |
| Frequency-weighted IoU | 76.62 | 76.56 |
| Fixed GT-present class mIoU | 45.97 | 46.12 |
| Boundary F1 | 49.04 | 49.09 |
...
| Peak training VRAM, retained training invocation (GiB) | 15.83 |
| Peak evaluation VRAM (GiB) | 8.11 |
| Retained training invocation wall time (seconds) | 5362.76 |
| Retained training invocation GPU-hours (one GPU) | 1.49 |
...
| Status | Parameters | Weight MiB | FPS | p50 ms | p95 ms | Peak reserved GiB |
| --- | --- | --- | --- | --- | --- | --- |
| complete | 38230389 | 145.84 | 29.14 | 34.31 | 34.45 | 1.95 |

```json
{
  "schema_version": 1,
  "model_id": "native_convnext_tiny_channelmapper_dpt",
  "measured_at": "2026-09-06T18:47:31+00:00",
  "status": "complete",
  "benchmark_scope": "rtis_selected_checkpoint_model_only",
  "applies_to": [
    "native_convnext_tiny_channelmapper_dpt--railsem19_to_rtis--seed-2"
  ],
  "source": {
    "campaign_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "git_dirty": false,
    "config_hash": "b924f78a69fe",
    "resolved_config": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/configs/native_convnext_tiny_channelmapper_dpt--railsem19_to_rtis--seed-2.yaml",
    "config_sha256": "b11d6c0d44d7c5bc9431c7ab24596f537f48aa81248a61dd69abf32bd401b0e5",
    "checkpoint_sha256": "a9b31e126f52822023726abd687e568fdda1f4bf1bcfc065b28a6a1a80857077",
    "checkpoint_global_step": 2036,
    "checkpoint_bytes": 612094805,
    "checkpoint_kind": "resume checkpoint with optimizer and EMA state",
    "weights": "ema",
    "measured_checkpoint_job_id": "native_convnext_tiny_channelmapper_dpt--railsem19_to_rtis--seed-2",
    "result_sha256": "38f5e8242c7503b4d8b3aa83596dcd86e7df2ee22ee5bdcbe81474a4fca75af6",
    "result_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "result_stage": "eval:paul-test-rtis:val",
    "result_seed": 2
  },
  ...
  "measurements": {
    "latency": {
      "p50_ms": 34.31014442443848,
      "p95_ms": 34.4497573852539,
      "mean_ms": 34.31718299865722,
      "minimum_ms": 34.17599868774414,
      "maximum_ms": 34.5241584777832,
      "fps": 29.13992095560782,
      "raw_ms": [
        34.36851119995117,
        34.20979309082031,
        34.325504302978516,
    ...
    "peak_reserved_bytes": 2090860544,
    "memory_kind": "pytorch_cuda_allocator_peak_reserved_excluding_context",
    "benchmark_wall_clock_s": 10.327015798538923
  },
  "started_at": "2026-09-06T18:47:20+00:00",
  "finished_at": "2026-09-06T18:47:31+00:00",
  "environment": {
    "hostname": "hdrfs-app-001",
    "python": "3.11.15",
    "platform": "Linux-5.15.0-139-generic-x86_64-with-glibc2.35",
...
| Class | GT pixels | IoU (%) | Precision (%) | Recall (%) | Dice (%) | Boundary F1 (%) |
| --- | --- | --- | --- | --- | --- | --- |
| car | 29664 | 38.79 | 57.64 | 54.26 | 55.90 | 43.28 |
| construction | 311585 | 43.35 | 49.14 | 78.62 | 60.48 | 42.01 |
| fence | 265137 | 29.11 | 63.74 | 34.88 | 45.09 | 48.41 |
| mud-pumping | 1226250 | 1.99 | 5.73 | 2.96 | 3.91 | 4.99 |
| on-rails | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| person | 0 | — | — | — | — | — |
| pole | 628038 | 75.19 | 85.81 | 85.87 | 85.84 | 92.53 |
| rail-embedded | 16799 | 61.89 | 83.17 | 70.74 | 76.46 | 90.60 |
| rail-raised | 2969797 | 79.26 | 87.12 | 89.78 | 88.43 | 92.93 |
| rail-track | 6323197 | 45.22 | 63.63 | 60.99 | 62.28 | 60.25 |
| road | 1048831 | 12.61 | 30.99 | 17.54 | 22.40 | 23.46 |
| sidewalk | 1297367 | 32.69 | 66.86 | 39.01 | 49.28 | 22.85 |
| sky | 19121606 | 98.93 | 99.36 | 99.57 | 99.46 | 97.88 |
| standing-water | 95802 | 0.98 | 1.29 | 3.85 | 1.93 | 3.62 |
| terrain | 39239306 | 87.60 | 88.96 | 98.29 | 93.39 | 69.44 |
| trackbed | 10643081 | 62.71 | 74.43 | 79.94 | 77.08 | 60.58 |
| traffic-light | 19510 | 42.82 | 75.53 | 49.72 | 59.97 | 70.14 |
| traffic-sign | 13285 | 48.71 | 79.45 | 55.73 | 65.51 | 69.29 |
| tram-track | 56179 | 34.34 | 36.73 | 84.02 | 51.12 | 22.55 |
| truck | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| vegetation-overgrowth | 5901821 | 31.32 | 82.90 | 33.48 | 47.70 | 66.08 |

### Full-run accounting

| Measurement | Value |
| --- | --- |
| Full GPU-reserved wall seconds, all recorded worker attempts | 5600.81 |
| Full reserved GPU-hours | 1.56 |
| Whole-run timing complete | True |
...
| Checkpoint / weights / split | Images | Mud IoU (%) | Mud precision (%) | Mud recall (%) |
| --- | --- | --- | --- | --- |
| best-auto-train / ema | 220 | 97.61 | 98.79 | 98.79 |
| best-auto-val / ema | 37 | 1.99 | 5.73 | 2.96 |
| best-alternate-val / raw | 37 | 1.07 | 3.85 | 1.47 |
| final-auto-val / ema | 37 | 1.88 | 5.47 | 2.79 |
...
```json
{
  ...
  "checkpoints": {
    "best": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/native_convnext_tiny_channelmapper_dpt--railsem19_to_rtis--seed-2_seed2/rtis/best.ckpt",
      "sha256": "a9b31e126f52822023726abd687e568fdda1f4bf1bcfc065b28a6a1a80857077",
      "global_step": 2036,
      "bytes": 612094805
    },
    "final": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/native_convnext_tiny_channelmapper_dpt--railsem19_to_rtis--seed-2_seed2/rtis/last.ckpt",
      "sha256": "475bfd43b8f830a1ed8565b83cd89a8af2958bbac9e39c3213412d256b8d3208",
      "global_step": 3309,
      "bytes": 612083285
    }
  },
...
Status: **completed**. Started: 2026-09-06T17:33:42.339093+00:00. Finished: 2026-09-06T18:40:10.889191+00:00.
...
| Status | Parameters | Weight MiB | FPS | p50 ms | p95 ms | Peak reserved GiB |
| --- | --- | --- | --- | --- | --- | --- |
| complete | 38230389 | 145.84 | 28.89 | 34.60 | 34.73 | 1.95 |

```json
{
  "schema_version": 1,
  "model_id": "native_convnext_tiny_channelmapper_dpt",
  "measured_at": "2026-09-06T18:40:06+00:00",
  "status": "complete",
  "benchmark_scope": "rtis_selected_checkpoint_model_only",
  "applies_to": [
    "native_convnext_tiny_channelmapper_dpt--cityscapes_to_railsem19_to_rtis--seed-1"
  ],
  "source": {
    "campaign_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "git_dirty": false,
    "config_hash": "34d5eb30bdd2",
    "resolved_config": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/configs/native_convnext_tiny_channelmapper_dpt--cityscapes_to_railsem19_to_rtis--seed-1.yaml",
    "config_sha256": "3d240ef3523568b834e83a489f510f1e427ecbc94f3968655f62202a64d08c24",
    "checkpoint_sha256": "ba495abd07f514625afaaeca3c3908aac2e7defa1db639e50d2d9fa9b0dad005",
    "checkpoint_global_step": 1018,
    "checkpoint_bytes": 612094869,
    "checkpoint_kind": "resume checkpoint with optimizer and EMA state",
    "weights": "ema",
    "measured_checkpoint_job_id": "native_convnext_tiny_channelmapper_dpt--cityscapes_to_railsem19_to_rtis--seed-1",
    "result_sha256": "d1731a8cdb7529c428570a8843233fc86b1dcbbc51d6cd8a38ae147baf200778",
    "result_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "result_stage": "eval:paul-test-rtis:val",
    "result_seed": 1
  },
  ...
  "measurements": {
    "latency": {
      "p50_ms": 34.60198402404785,
      "p95_ms": 34.7269645690918,
      "mean_ms": 34.61725952148438,
      "minimum_ms": 34.521087646484375,
      "maximum_ms": 34.9562873840332,
      "fps": 28.887324237187922,
      "raw_ms": [
        34.746368408203125,
        34.66444778442383,
        34.63577651977539,
    ...
    "peak_reserved_bytes": 2090860544,
    "memory_kind": "pytorch_cuda_allocator_peak_reserved_excluding_context",
    "benchmark_wall_clock_s": 10.440037239342928
  },
  "started_at": "2026-09-06T18:39:55+00:00",
  "finished_at": "2026-09-06T18:40:06+00:00",
  "environment": {
    "hostname": "hdrfs-app-001",
    "python": "3.11.15",
    "platform": "Linux-5.15.0-139-generic-x86_64-with-glibc2.35",
...
| Measurement | Value |
| --- | --- |
| Full GPU-reserved wall seconds, all recorded worker attempts | 3988.98 |
| Full reserved GPU-hours | 1.11 |
| Whole-run timing complete | True |
...
| Checkpoint / weights / split | Images | Mud IoU (%) | Mud precision (%) | Mud recall (%) |
| --- | --- | --- | --- | --- |
| best-auto-train / ema | 220 | 96.55 | 98.21 | 98.28 |
| best-auto-val / ema | 37 | 2.24 | 3.89 | 5.02 |
| best-alternate-val / raw | 37 | 2.55 | 4.67 | 5.32 |
| final-auto-val / ema | 37 | 1.65 | 2.56 | 4.41 |
...
Status: **completed**. Started: 2026-09-06T17:41:23.631472+00:00. Finished: 2026-09-06T18:40:53.302700+00:00.
...
| Status | Parameters | Weight MiB | FPS | p50 ms | p95 ms | Peak reserved GiB |
| --- | --- | --- | --- | --- | --- | --- |
| complete | 38230389 | 145.84 | 28.83 | 34.67 | 34.79 | 1.95 |

```json
{
  "schema_version": 1,
  "model_id": "native_convnext_tiny_channelmapper_dpt",
  "measured_at": "2026-09-06T18:40:48+00:00",
  "status": "complete",
  "benchmark_scope": "rtis_selected_checkpoint_model_only",
  "applies_to": [
    "native_convnext_tiny_channelmapper_dpt--cityscapes_to_railsem19_to_rtis--seed-2"
  ],
  "source": {
    "campaign_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "git_dirty": false,
    "config_hash": "369c4490945f",
    "resolved_config": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/configs/native_convnext_tiny_channelmapper_dpt--cityscapes_to_railsem19_to_rtis--seed-2.yaml",
    "config_sha256": "87a51a0d78370050d0e9aacaee2f925bdce2d21313a49c9b8ee36b94f65bfa65",
    "checkpoint_sha256": "615a5622eb41a7b3a5a5f187b302370cd14493c9f7e41a375092792b82b5fe56",
    "checkpoint_global_step": 1781,
    "checkpoint_bytes": 612094869,
    "checkpoint_kind": "resume checkpoint with optimizer and EMA state",
    "weights": "ema",
    "measured_checkpoint_job_id": "native_convnext_tiny_channelmapper_dpt--cityscapes_to_railsem19_to_rtis--seed-2",
    "result_sha256": "40b1aa5966cbb5e0cffed99ff4d9d5c8f2693368a91915bd66333fb56e607f3e",
    "result_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "result_stage": "eval:paul-test-rtis:val",
    "result_seed": 2
  },
  ...
  "measurements": {
    "latency": {
      "p50_ms": 34.6695671081543,
      "p95_ms": 34.7943416595459,
      "mean_ms": 34.690969467163086,
      "minimum_ms": 34.535423278808594,
      "maximum_ms": 36.15641784667969,
      "fps": 28.825945638289387,
      "raw_ms": [
        34.64191818237305,
        34.581504821777344,
        34.753536224365234,
    ...
    "peak_reserved_bytes": 2090860544,
    "memory_kind": "pytorch_cuda_allocator_peak_reserved_excluding_context",
    "benchmark_wall_clock_s": 10.628887888044119
  },
  "started_at": "2026-09-06T18:40:37+00:00",
  "finished_at": "2026-09-06T18:40:48+00:00",
  "environment": {
    "hostname": "hdrfs-app-001",
    "python": "3.11.15",
    "platform": "Linux-5.15.0-139-generic-x86_64-with-glibc2.35",
...
| Measurement | Value |
| --- | --- |
| Full GPU-reserved wall seconds, all recorded worker attempts | 3570.12 |
...
| Checkpoint / weights / split | Images | Mud IoU (%) | Mud precision (%) | Mud recall (%) |
| --- | --- | --- | --- | --- |
| best-auto-train / ema | 220 | 97.47 | 98.75 | 98.69 |
| best-auto-val / ema | 37 | 2.25 | 5.22 | 3.82 |
| best-alternate-val / raw | 37 | 2.93 | 5.98 | 5.44 |
| final-auto-val / ema | 37 | 2.07 | 4.20 | 3.93 |
