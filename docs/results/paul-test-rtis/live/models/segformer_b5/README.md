...
| segformer_b5 | cityscapes_to_railsem19_to_rtis | 0 | completed | 3818 | 2545 | 4.04 | 4.50 | 27.96 | 3.10 | 47.39 | 50.03 |
| segformer_b5 | cityscapes_to_railsem19_to_rtis | 1 | completed | 4000 | 3818 | 6.55 | 7.36 | 37.32 | 6.20 | 45.95 | 51.06 |
| segformer_b5 | cityscapes_to_railsem19_to_rtis | 2 | completed | 3818 | 2545 | 4.69 | 5.38 | 26.63 | 3.92 | 45.41 | 50.46 |
...
Status: **completed**. Started: 2026-09-07T03:41:33.020798+00:00. Finished: 2026-09-07T05:28:55.851009+00:00.
...
| Status | Parameters | Weight MiB | FPS | p50 ms | p95 ms | Peak reserved GiB |
| --- | --- | --- | --- | --- | --- | --- |
| complete | 84609493 | 322.76 | 26.39 | 37.13 | 44.16 | 2.57 |

```json
{
  "schema_version": 1,
  "model_id": "segformer_b5",
  "measured_at": "2026-09-07T05:28:43+00:00",
  "status": "complete",
  "benchmark_scope": "rtis_selected_checkpoint_model_only",
  "applies_to": [
  ...
  "source": {
    "campaign_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "git_dirty": false,
    "config_hash": "7f78288165eb",
    "resolved_config": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/configs/segformer_b5--cityscapes_to_railsem19_to_rtis--seed-0.yaml",
    "config_sha256": "e2bb7ca10cf07f2250471ec18ecae32ccbcbe4ef85e87e9b7ccdc7cb07a2af63",
    "checkpoint_sha256": "fda5fe85f62d18f352a8f26452561839bac8feae94e8b14ca216282b98334d78",
    "checkpoint_global_step": 2545,
    "checkpoint_bytes": 1355768057,
    "checkpoint_kind": "resume checkpoint with optimizer and EMA state",
    "weights": "raw",
    "measured_checkpoint_job_id": "segformer_b5--cityscapes_to_railsem19_to_rtis--seed-0",
    "result_sha256": "c6502586d2d1716bfdc40c8da4e2b85b324bd650f874fa516d0351245c156412",
    "result_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "result_stage": "eval:paul-test-rtis:val",
    "result_seed": 0
  },
  ...
  "measurements": {
    "latency": {
      "p50_ms": 37.1276798248291,
      "p95_ms": 44.15948905944824,
      "mean_ms": 37.89908901214599,
      "minimum_ms": 35.86048126220703,
      "maximum_ms": 44.95462417602539,
      "fps": 26.385858501229873,
      "raw_ms": [
        38.46451187133789,
        36.529151916503906,
        36.36323165893555,
    ...
    "peak_reserved_bytes": 2755657728,
    "memory_kind": "pytorch_cuda_allocator_peak_reserved_excluding_context",
    "benchmark_wall_clock_s": 7.871089871972799
  },
  "started_at": "2026-09-07T05:28:35+00:00",
  "finished_at": "2026-09-07T05:28:43+00:00",
  "environment": {
    "hostname": "hdrfs-app-001",
    "python": "3.11.15",
    "platform": "Linux-5.15.0-139-generic-x86_64-with-glibc2.35",
...
| Measurement | Value |
| --- | --- |
| Full GPU-reserved wall seconds, all recorded worker attempts | 6443.95 |
...
| Checkpoint / weights / split | Images | Mud IoU (%) | Mud precision (%) | Mud recall (%) |
| --- | --- | --- | --- | --- |
| best-auto-train / raw | 220 | 95.48 | 97.38 | 98.00 |
| best-auto-val / raw | 37 | 4.04 | 4.50 | 27.96 |
| best-alternate-val / ema | 37 | 1.82 | 2.09 | 12.24 |
| final-auto-val / raw | 37 | 3.10 | 3.48 | 22.11 |
...
Status: **completed**. Started: 2026-09-07T03:49:12.223612+00:00. Finished: 2026-09-07T05:43:11.334004+00:00.
...
Config SHA-256: `1c375e7abc1f32b1e30fd199eb30fb10d906818e4d326f0fe421c5a96ff31ec2`. Weights used for validation: `raw`.
...
| --- | --- | --- |
| Mud IoU | 6.55 | 6.20 |
| Mud precision | 7.36 | 7.23 |
| Mud recall | 37.32 | 30.32 |
| Mud Dice/F1 | 12.30 | 11.68 |
| mIoU | 45.95 | 45.97 |
| Mean accuracy | 59.94 | 59.71 |
| Mean precision | 65.07 | 64.64 |
| Mean Dice | 56.31 | 56.22 |
| Mean specificity | 99.10 | 99.12 |
| Pixel accuracy | 84.41 | 84.84 |
| Frequency-weighted IoU | 78.02 | 78.17 |
| Fixed GT-present class mIoU | 51.06 | 51.08 |
| Boundary F1 | 54.04 | 53.85 |
...
| Peak training VRAM, retained training invocation (GiB) | 16.31 |
| Peak evaluation VRAM (GiB) | 7.78 |
| Retained training invocation wall time (seconds) | 6523.98 |
...
| Status | Parameters | Weight MiB | FPS | p50 ms | p95 ms | Peak reserved GiB |
| --- | --- | --- | --- | --- | --- | --- |
| complete | 84609493 | 322.76 | 26.44 | 37.29 | 41.73 | 2.57 |

```json
{
  "schema_version": 1,
  "model_id": "segformer_b5",
  "measured_at": "2026-09-07T05:42:57+00:00",
  "status": "complete",
  "benchmark_scope": "rtis_selected_checkpoint_model_only",
  "applies_to": [
    "segformer_b5--cityscapes_to_railsem19_to_rtis--seed-1"
  ],
  "source": {
    "campaign_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "git_dirty": false,
    "config_hash": "5e9610ae7f64",
    "resolved_config": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/configs/segformer_b5--cityscapes_to_railsem19_to_rtis--seed-1.yaml",
    "config_sha256": "1c375e7abc1f32b1e30fd199eb30fb10d906818e4d326f0fe421c5a96ff31ec2",
    "checkpoint_sha256": "5893d1c8c4f631b6889ffb6ec2dca4619de75606584fda9b6cc31dd0b8dbbd55",
    "checkpoint_global_step": 3818,
    "checkpoint_bytes": 1355768057,
    "checkpoint_kind": "resume checkpoint with optimizer and EMA state",
    "weights": "raw",
    "measured_checkpoint_job_id": "segformer_b5--cityscapes_to_railsem19_to_rtis--seed-1",
    "result_sha256": "b54ae209c92983f723c83bd62540e7dd70091cb02a04e1b22172a746cf4484e1",
    "result_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "result_stage": "eval:paul-test-rtis:val",
    "result_seed": 1
  },
  ...
  "measurements": {
    "latency": {
      "p50_ms": 37.29302406311035,
      "p95_ms": 41.72539024353027,
      "mean_ms": 37.8247452545166,
      "minimum_ms": 36.425758361816406,
      "maximum_ms": 44.12108612060547,
      "fps": 26.437719362580278,
      "raw_ms": [
        37.644287109375,
        36.801536560058594,
        36.979713439941406,
    ...
    "peak_reserved_bytes": 2755657728,
    "memory_kind": "pytorch_cuda_allocator_peak_reserved_excluding_context",
    "benchmark_wall_clock_s": 7.781650833785534
  },
  "started_at": "2026-09-07T05:42:49+00:00",
  "finished_at": "2026-09-07T05:42:57+00:00",
  "environment": {
    "hostname": "hdrfs-app-001",
    "python": "3.11.15",
    "platform": "Linux-5.15.0-139-generic-x86_64-with-glibc2.35",
...
| Class | GT pixels | IoU (%) | Precision (%) | Recall (%) | Dice (%) | Boundary F1 (%) |
| --- | --- | --- | --- | --- | --- | --- |
| car | 29664 | 74.48 | 79.76 | 91.84 | 85.37 | 64.91 |
| construction | 311585 | 60.33 | 73.90 | 76.67 | 75.26 | 68.51 |
| fence | 265137 | 18.01 | 81.90 | 18.75 | 30.52 | 51.01 |
| mud-pumping | 1226250 | 6.55 | 7.36 | 37.32 | 12.30 | 14.06 |
| on-rails | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| person | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| pole | 628038 | 75.95 | 85.86 | 86.81 | 86.33 | 92.37 |
| rail-embedded | 16799 | 59.58 | 84.45 | 66.93 | 74.67 | 89.53 |
| rail-raised | 2969797 | 77.53 | 84.98 | 89.84 | 87.34 | 91.83 |
| rail-track | 6323197 | 36.73 | 82.78 | 39.77 | 53.73 | 45.53 |
| road | 1048831 | 11.64 | 24.69 | 18.04 | 20.85 | 22.25 |
| sidewalk | 1297367 | 26.55 | 81.46 | 28.26 | 41.96 | 15.56 |
| sky | 19121606 | 98.87 | 99.26 | 99.60 | 99.43 | 97.49 |
| standing-water | 95802 | 3.25 | 4.14 | 13.11 | 6.29 | 9.33 |
| terrain | 39239306 | 90.40 | 92.40 | 97.66 | 94.96 | 74.54 |
| trackbed | 10643081 | 61.42 | 80.35 | 72.28 | 76.10 | 63.22 |
| traffic-light | 19510 | 59.23 | 96.23 | 60.64 | 74.40 | 69.67 |
| traffic-sign | 13285 | 50.81 | 80.13 | 58.13 | 67.38 | 73.81 |
| tram-track | 56179 | 61.69 | 82.70 | 70.83 | 76.31 | 67.01 |
| truck | 0 | — | — | — | — | — |
| vegetation-overgrowth | 5901821 | 46.00 | 78.98 | 52.42 | 63.02 | 70.20 |

### Full-run accounting

| Measurement | Value |
| --- | --- |
| Full GPU-reserved wall seconds, all recorded worker attempts | 6840.04 |
...
| Checkpoint / weights / split | Images | Mud IoU (%) | Mud precision (%) | Mud recall (%) |
| --- | --- | --- | --- | --- |
| best-auto-train / raw | 220 | 95.79 | 97.53 | 98.17 |
| best-auto-val / raw | 37 | 6.55 | 7.36 | 37.32 |
| best-alternate-val / ema | 37 | 3.86 | 4.49 | 21.56 |
| final-auto-val / raw | 37 | 6.20 | 7.23 | 30.33 |
...
```json
{
  ...
  "checkpoints": {
    "best": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/segformer_b5--cityscapes_to_railsem19_to_rtis--seed-1_seed1/rtis/best.ckpt",
      "sha256": "5893d1c8c4f631b6889ffb6ec2dca4619de75606584fda9b6cc31dd0b8dbbd55",
      "global_step": 3818,
      "bytes": 1355768057
    },
    "final": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/segformer_b5--cityscapes_to_railsem19_to_rtis--seed-1_seed1/rtis/last.ckpt",
      "sha256": "4ce34ee33086b145b99c568bf3062f46997f71091fed5314fe3697d6bcb9f122",
      "global_step": 4000,
      "bytes": 1355711865
    }
  },
...
Status: **completed**. Started: 2026-09-07T03:50:58.526465+00:00. Finished: 2026-09-07T05:37:21.160161+00:00.
...
Config SHA-256: `c0fc10b0d1f578812474a131d2a3b43fd1fc286aa4b07c0f47f9b4da91271b77`. Weights used for validation: `raw`.
...
| --- | --- | --- |
| Mud IoU | 4.69 | 3.92 |
| Mud precision | 5.38 | 4.48 |
| Mud recall | 26.63 | 23.84 |
| Mud Dice/F1 | 8.95 | 7.54 |
| mIoU | 45.41 | 44.87 |
| Mean accuracy | 59.00 | 58.35 |
| Mean precision | 64.62 | 64.17 |
| Mean Dice | 56.00 | 55.39 |
| Mean specificity | 99.07 | 99.09 |
| Pixel accuracy | 84.18 | 84.13 |
| Frequency-weighted IoU | 77.66 | 78.07 |
| Fixed GT-present class mIoU | 50.46 | 49.86 |
| Boundary F1 | 54.67 | 53.84 |
...
| Peak training VRAM, retained training invocation (GiB) | 16.31 |
| Peak evaluation VRAM (GiB) | 7.78 |
| Retained training invocation wall time (seconds) | 6069.40 |
| Retained training invocation GPU-hours (one GPU) | 1.69 |
| Evaluation wall time (seconds) | 29.21 |
| Full evaluation pipeline images/second | 1.27 |
| Best full-state checkpoint (MiB) | 1292.96 |
| Final full-state checkpoint (MiB) | 1292.91 |
| Audited periodic checkpoints removed (GiB) | 8.84 |
...
| Status | Parameters | Weight MiB | FPS | p50 ms | p95 ms | Peak reserved GiB |
| --- | --- | --- | --- | --- | --- | --- |
| complete | 84609493 | 322.76 | 26.64 | 37.17 | 39.53 | 2.57 |

```json
{
  "schema_version": 1,
  "model_id": "segformer_b5",
  "measured_at": "2026-09-07T05:37:08+00:00",
  "status": "complete",
  "benchmark_scope": "rtis_selected_checkpoint_model_only",
  "applies_to": [
    "segformer_b5--cityscapes_to_railsem19_to_rtis--seed-2"
  ],
  "source": {
    "campaign_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "git_dirty": false,
    "config_hash": "cc20d0ad6a00",
    "resolved_config": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/configs/segformer_b5--cityscapes_to_railsem19_to_rtis--seed-2.yaml",
    "config_sha256": "c0fc10b0d1f578812474a131d2a3b43fd1fc286aa4b07c0f47f9b4da91271b77",
    "checkpoint_sha256": "e0abb88acf394e0e4c021ea9b1c7bb8c463df33853c9bbc4c76e07dfc4130716",
    "checkpoint_global_step": 2545,
    "checkpoint_bytes": 1355768057,
    "checkpoint_kind": "resume checkpoint with optimizer and EMA state",
    "weights": "raw",
    "measured_checkpoint_job_id": "segformer_b5--cityscapes_to_railsem19_to_rtis--seed-2",
    "result_sha256": "0f9b19e14aa7353f2fc195810ce0bf1b6c1eb0bcc4065bf24cd7bcbfde52963c",
    "result_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "result_stage": "eval:paul-test-rtis:val",
    "result_seed": 2
  },
  ...
  "measurements": {
    "latency": {
      "p50_ms": 37.171199798583984,
      "p95_ms": 39.53167247772217,
      "mean_ms": 37.53162693023682,
      "minimum_ms": 36.506622314453125,
      "maximum_ms": 41.194496154785156,
      "fps": 26.644195357125973,
      "raw_ms": [
        39.20588684082031,
        37.86444854736328,
        37.226497650146484,
    ...
    "peak_reserved_bytes": 2755657728,
    "memory_kind": "pytorch_cuda_allocator_peak_reserved_excluding_context",
    "benchmark_wall_clock_s": 7.758629206568003
  },
  "started_at": "2026-09-07T05:37:01+00:00",
  "finished_at": "2026-09-07T05:37:08+00:00",
  "environment": {
    "hostname": "hdrfs-app-001",
    "python": "3.11.15",
    "platform": "Linux-5.15.0-139-generic-x86_64-with-glibc2.35",
...
| Class | GT pixels | IoU (%) | Precision (%) | Recall (%) | Dice (%) | Boundary F1 (%) |
| --- | --- | --- | --- | --- | --- | --- |
| car | 29664 | 71.85 | 78.13 | 89.93 | 83.62 | 60.29 |
| construction | 311585 | 63.97 | 82.47 | 74.04 | 78.03 | 71.77 |
| fence | 265137 | 22.70 | 79.97 | 24.07 | 37.01 | 56.61 |
| mud-pumping | 1226250 | 4.69 | 5.38 | 26.63 | 8.95 | 10.75 |
| on-rails | 0 | — | — | — | — | — |
| person | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| pole | 628038 | 75.42 | 84.81 | 87.20 | 85.99 | 92.29 |
| rail-embedded | 16799 | 59.12 | 78.36 | 70.66 | 74.31 | 88.77 |
| rail-raised | 2969797 | 80.69 | 88.87 | 89.77 | 89.31 | 95.36 |
| rail-track | 6323197 | 37.13 | 76.54 | 41.91 | 54.16 | 48.87 |
| road | 1048831 | 12.76 | 26.16 | 19.95 | 22.64 | 24.24 |
| sidewalk | 1297367 | 26.89 | 79.78 | 28.86 | 42.38 | 11.52 |
| sky | 19121606 | 98.88 | 99.43 | 99.44 | 99.44 | 97.46 |
| standing-water | 95802 | 4.54 | 7.13 | 11.09 | 8.68 | 14.67 |
| terrain | 39239306 | 90.13 | 91.53 | 98.33 | 94.81 | 73.73 |
| trackbed | 10643081 | 59.32 | 79.02 | 70.40 | 74.46 | 62.41 |
| traffic-light | 19510 | 48.61 | 97.22 | 49.30 | 65.42 | 78.38 |
| traffic-sign | 13285 | 49.33 | 83.79 | 54.54 | 66.07 | 74.23 |
| tram-track | 56179 | 58.34 | 69.84 | 77.99 | 73.69 | 60.10 |
| truck | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| vegetation-overgrowth | 5901821 | 43.85 | 83.97 | 47.86 | 60.97 | 71.93 |

### Full-run accounting

| Measurement | Value |
| --- | --- |
| Full GPU-reserved wall seconds, all recorded worker attempts | 6383.66 |
...
| Checkpoint / weights / split | Images | Mud IoU (%) | Mud precision (%) | Mud recall (%) |
| --- | --- | --- | --- | --- |
| best-auto-train / raw | 220 | 95.57 | 97.43 | 98.04 |
| best-auto-val / raw | 37 | 4.69 | 5.38 | 26.63 |
| best-alternate-val / ema | 37 | 2.80 | 3.22 | 17.68 |
| final-auto-val / raw | 37 | 3.92 | 4.48 | 23.85 |
...
```json
{
  ...
  "checkpoints": {
    "best": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/segformer_b5--cityscapes_to_railsem19_to_rtis--seed-2_seed2/rtis/best.ckpt",
      "sha256": "e0abb88acf394e0e4c021ea9b1c7bb8c463df33853c9bbc4c76e07dfc4130716",
      "global_step": 2545,
      "bytes": 1355768057
    },
    "final": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/segformer_b5--cityscapes_to_railsem19_to_rtis--seed-2_seed2/rtis/last.ckpt",
      "sha256": "8acb6aab535458b470a11bd6ae49f649ed5085b03e1d924814e17dbb2e2f597f",
      "global_step": 3818,
      "bytes": 1355712057
    }
  },
