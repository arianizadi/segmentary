...
| native_resnet18_fpn_segformer_aux | cityscapes_to_rtis | 2 | completed | 4000 | 2800 | 0.69 | 0.91 | 2.80 | 0.44 | 29.66 | 34.60 |
| native_resnet18_fpn_segformer_aux | railsem19_to_rtis | 0 | completed | 2800 | 1527 | 1.12 | 2.25 | 2.17 | 0.04 | 36.37 | 42.43 |
| native_resnet18_fpn_segformer_aux | railsem19_to_rtis | 1 | completed | 3309 | 2036 | 1.72 | 2.21 | 7.14 | 0.30 | 32.08 | 37.43 |
...
| native_resnet18_fpn_segformer_aux | cityscapes_to_railsem19_to_rtis | 1 | completed | 3309 | 2036 | 4.21 | 5.34 | 16.53 | 1.93 | 31.68 | 36.96 |
| native_resnet18_fpn_segformer_aux | cityscapes_to_railsem19_to_rtis | 2 | completed | 2290 | 1018 | 4.81 | 7.12 | 12.87 | 2.17 | 30.94 | 34.38 |
...
| Verified periodic checkpoints removed (GiB) | 0.54 |
...
| Best full-state checkpoint (MiB) | 184.91 |
| Final full-state checkpoint (MiB) | 184.90 |
| Verified periodic checkpoints removed (GiB) | 0.72 |
...
| Best full-state checkpoint (MiB) | 184.91 |
| Final full-state checkpoint (MiB) | 184.90 |
| Verified periodic checkpoints removed (GiB) | 1.08 |
...
Status: **completed**. Started: 2026-09-06T21:54:41.071768+00:00. Finished: 2026-09-06T22:38:05.289356+00:00.
...
Config SHA-256: `ce733bb8acd96e682540de2bb55812dbd907505f2ed52c2294a4d0d6bad510be`. Weights used for validation: `raw`.
...
| --- | --- | --- |
| Mud IoU | 0.69 | 0.44 |
| Mud precision | 0.91 | 0.66 |
| Mud recall | 2.80 | 1.32 |
| Mud Dice/F1 | 1.37 | 0.88 |
| mIoU | 29.66 | 29.22 |
| Mean accuracy | 44.37 | 43.79 |
| Mean precision | 44.17 | 42.83 |
| Mean Dice | 38.15 | 37.69 |
| Mean specificity | 98.86 | 98.85 |
| Pixel accuracy | 80.54 | 80.86 |
| Frequency-weighted IoU | 72.03 | 71.69 |
| Fixed GT-present class mIoU | 34.60 | 34.09 |
| Boundary F1 | 33.19 | 33.03 |
...
| Peak training VRAM, retained training invocation (GiB) | 7.76 |
| Peak evaluation VRAM (GiB) | 6.87 |
| Retained training invocation wall time (seconds) | 2479.27 |
...
| Status | Parameters | Weight MiB | FPS | p50 ms | p95 ms | Peak reserved GiB |
| --- | --- | --- | --- | --- | --- | --- |
| complete | 12100522 | 46.16 | 243.27 | 3.84 | 6.30 | 0.61 |

```json
{
  "schema_version": 1,
  "model_id": "native_resnet18_fpn_segformer_aux",
  "measured_at": "2026-09-06T22:38:02+00:00",
  "status": "complete",
  "benchmark_scope": "rtis_selected_checkpoint_model_only",
  "applies_to": [
    "native_resnet18_fpn_segformer_aux--cityscapes_to_rtis--seed-2"
  ],
  "source": {
    "campaign_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "git_dirty": false,
    "config_hash": "b86c48a6cefc",
    "resolved_config": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/configs/native_resnet18_fpn_segformer_aux--cityscapes_to_rtis--seed-2.yaml",
    "config_sha256": "ce733bb8acd96e682540de2bb55812dbd907505f2ed52c2294a4d0d6bad510be",
    "checkpoint_sha256": "59c9c745498b7e74609b6deebba63ce414c289b4e5245f5a7d01d18e722677b9",
    "checkpoint_global_step": 2800,
    "checkpoint_bytes": 193887861,
    "checkpoint_kind": "resume checkpoint with optimizer and EMA state",
    "weights": "raw",
    "measured_checkpoint_job_id": "native_resnet18_fpn_segformer_aux--cityscapes_to_rtis--seed-2",
    "result_sha256": "f5b2bcb263c2a1af567de8446892ef8d3eba8666002f619f357e0279c5292e8c",
    "result_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "result_stage": "eval:paul-test-rtis:val",
    "result_seed": 2
  },
  ...
  "measurements": {
    "latency": {
      "p50_ms": 3.8435839414596558,
      "p95_ms": 6.29713921546936,
      "mean_ms": 4.110670719146729,
      "minimum_ms": 3.827712059020996,
      "maximum_ms": 6.4686079025268555,
      "fps": 243.26930282744095,
      "raw_ms": [
        3.8748159408569336,
        3.845247983932495,
        3.8533120155334473,
    ...
    "peak_reserved_bytes": 656408576,
    "memory_kind": "pytorch_cuda_allocator_peak_reserved_excluding_context",
    "benchmark_wall_clock_s": 10.464851137250662
  },
  "started_at": "2026-09-06T22:37:51+00:00",
  "finished_at": "2026-09-06T22:38:02+00:00",
  "environment": {
    "hostname": "hdrfs-app-001",
    "python": "3.11.15",
    "platform": "Linux-5.15.0-139-generic-x86_64-with-glibc2.35",
...
| Class | GT pixels | IoU (%) | Precision (%) | Recall (%) | Dice (%) | Boundary F1 (%) |
| --- | --- | --- | --- | --- | --- | --- |
| car | 29664 | 47.10 | 75.16 | 55.78 | 64.03 | 44.56 |
| construction | 311585 | 27.66 | 30.91 | 72.43 | 43.33 | 26.83 |
| fence | 265137 | 3.88 | 10.81 | 5.71 | 7.47 | 9.50 |
| mud-pumping | 1226250 | 0.69 | 0.91 | 2.80 | 1.37 | 1.92 |
| on-rails | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| person | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| pole | 628038 | 66.75 | 80.96 | 79.19 | 80.06 | 86.66 |
| rail-embedded | 16799 | 5.67 | 11.57 | 10.00 | 10.73 | 9.60 |
| rail-raised | 2969797 | 67.32 | 75.23 | 86.48 | 80.47 | 83.81 |
| rail-track | 6323197 | 32.95 | 62.54 | 41.05 | 49.56 | 46.39 |
| road | 1048831 | 21.64 | 34.81 | 36.38 | 35.58 | 23.90 |
| sidewalk | 1297367 | 6.36 | 63.29 | 6.61 | 11.97 | 6.56 |
| sky | 19121606 | 97.64 | 99.45 | 98.17 | 98.81 | 90.91 |
| standing-water | 95802 | 2.09 | 2.92 | 6.82 | 4.09 | 14.01 |
| terrain | 39239306 | 86.13 | 90.20 | 95.02 | 92.55 | 49.81 |
| trackbed | 10643081 | 52.56 | 63.92 | 74.72 | 68.90 | 47.16 |
| traffic-light | 19510 | 57.38 | 85.82 | 63.39 | 72.92 | 59.71 |
| traffic-sign | 13285 | 19.71 | 62.90 | 22.30 | 32.93 | 42.62 |
| tram-track | 56179 | 6.23 | 8.61 | 18.34 | 11.72 | 5.36 |
| truck | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| vegetation-overgrowth | 5901821 | 21.03 | 67.51 | 23.40 | 34.76 | 47.57 |

### Full-run accounting

| Measurement | Value |
| --- | --- |
| Full GPU-reserved wall seconds, all recorded worker attempts | 2604.36 |
...
| Checkpoint / weights / split | Images | Mud IoU (%) | Mud precision (%) | Mud recall (%) |
| --- | --- | --- | --- | --- |
| best-auto-train / raw | 220 | 90.18 | 94.41 | 95.27 |
| best-auto-val / raw | 37 | 0.69 | 0.91 | 2.80 |
| best-alternate-val / ema | 37 | 0.56 | 0.80 | 1.85 |
| final-auto-val / raw | 37 | 0.44 | 0.66 | 1.32 |
...
```json
{
  ...
  "checkpoints": {
    "best": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/native_resnet18_fpn_segformer_aux--cityscapes_to_rtis--seed-2_seed2/rtis/best.ckpt",
      "sha256": "59c9c745498b7e74609b6deebba63ce414c289b4e5245f5a7d01d18e722677b9",
      "global_step": 2800,
      "bytes": 193887861
    },
    "final": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/native_resnet18_fpn_segformer_aux--cityscapes_to_rtis--seed-2_seed2/rtis/last.ckpt",
      "sha256": "e4e18944ecc6286a8529cb5022cf5513b82c4b11899ba0ef49bfffce7b962aa7",
      "global_step": 4000,
      "bytes": 193882101
    }
  },
...
Status: **completed**. Started: 2026-09-06T22:00:51.669233+00:00. Finished: 2026-09-06T22:36:15.724089+00:00.
...
Config SHA-256: `44b9edfc572f590473a29cf32fef47310e51c5068c5bfcd2aaa94fdbb6fc6cd4`. Weights used for validation: `raw`.
...
| --- | --- | --- |
| Mud IoU | 1.72 | 0.30 |
| Mud precision | 2.21 | 0.57 |
| Mud recall | 7.14 | 0.62 |
| Mud Dice/F1 | 3.38 | 0.59 |
| mIoU | 32.08 | 34.20 |
| Mean accuracy | 43.99 | 48.15 |
| Mean precision | 57.20 | 53.00 |
| Mean Dice | 40.97 | 43.44 |
| Mean specificity | 98.86 | 98.96 |
| Pixel accuracy | 81.71 | 83.38 |
| Frequency-weighted IoU | 72.49 | 74.03 |
| Fixed GT-present class mIoU | 37.43 | 39.90 |
| Boundary F1 | 38.78 | 39.26 |
...
| Peak training VRAM, retained training invocation (GiB) | 7.76 |
| Peak evaluation VRAM (GiB) | 6.87 |
| Retained training invocation wall time (seconds) | 1999.53 |
...
| Status | Parameters | Weight MiB | FPS | p50 ms | p95 ms | Peak reserved GiB |
| --- | --- | --- | --- | --- | --- | --- |
| complete | 12100522 | 46.16 | 255.90 | 3.88 | 4.10 | 0.61 |

```json
{
  "schema_version": 1,
  "model_id": "native_resnet18_fpn_segformer_aux",
  "measured_at": "2026-09-06T22:36:12+00:00",
  "status": "complete",
  "benchmark_scope": "rtis_selected_checkpoint_model_only",
  "applies_to": [
    "native_resnet18_fpn_segformer_aux--railsem19_to_rtis--seed-1"
  ],
  "source": {
    "campaign_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "git_dirty": false,
    "config_hash": "c279c294def9",
    "resolved_config": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/configs/native_resnet18_fpn_segformer_aux--railsem19_to_rtis--seed-1.yaml",
    "config_sha256": "44b9edfc572f590473a29cf32fef47310e51c5068c5bfcd2aaa94fdbb6fc6cd4",
    "checkpoint_sha256": "ab50e15cc0b9d09d85891d8325708aed6595ad775cbaef8618d61c7c7bda58ca",
    "checkpoint_global_step": 2036,
    "checkpoint_bytes": 193887797,
    "checkpoint_kind": "resume checkpoint with optimizer and EMA state",
    "weights": "raw",
    "measured_checkpoint_job_id": "native_resnet18_fpn_segformer_aux--railsem19_to_rtis--seed-1",
    "result_sha256": "6ba7a221ac81fe2d12ccd0cb3b0c33cf62b1531170d521730f750bd597cbc04a",
    "result_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "result_stage": "eval:paul-test-rtis:val",
    "result_seed": 1
  },
  ...
  "measurements": {
    "latency": {
      "p50_ms": 3.8778879642486572,
      "p95_ms": 4.097535967826843,
      "mean_ms": 3.907717111110687,
      "minimum_ms": 3.8452160358428955,
      "maximum_ms": 4.481023788452148,
      "fps": 255.90388750422386,
      "raw_ms": [
        4.087808132171631,
        3.911679983139038,
        3.901439905166626,
    ...
    "peak_reserved_bytes": 656408576,
    "memory_kind": "pytorch_cuda_allocator_peak_reserved_excluding_context",
    "benchmark_wall_clock_s": 10.564266212284565
  },
  "started_at": "2026-09-06T22:36:02+00:00",
  "finished_at": "2026-09-06T22:36:12+00:00",
  "environment": {
    "hostname": "hdrfs-app-001",
    "python": "3.11.15",
    "platform": "Linux-5.15.0-139-generic-x86_64-with-glibc2.35",
...
| Class | GT pixels | IoU (%) | Precision (%) | Recall (%) | Dice (%) | Boundary F1 (%) |
| --- | --- | --- | --- | --- | --- | --- |
| car | 29664 | 33.58 | 69.80 | 39.29 | 50.28 | 39.20 |
| construction | 311585 | 54.44 | 70.36 | 70.65 | 70.50 | 61.89 |
| fence | 265137 | 5.41 | 14.47 | 7.95 | 10.27 | 18.46 |
| mud-pumping | 1226250 | 1.72 | 2.21 | 7.14 | 3.38 | 3.62 |
| on-rails | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| person | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| pole | 628038 | 70.35 | 79.16 | 86.34 | 82.59 | 87.84 |
| rail-embedded | 16799 | 4.94 | 96.30 | 4.95 | 9.42 | 24.04 |
| rail-raised | 2969797 | 74.82 | 82.36 | 89.10 | 85.60 | 88.53 |
| rail-track | 6323197 | 33.36 | 73.52 | 37.92 | 50.03 | 44.98 |
| road | 1048831 | 14.63 | 39.93 | 18.77 | 25.53 | 27.00 |
| sidewalk | 1297367 | 39.95 | 87.11 | 42.46 | 57.09 | 12.44 |
| sky | 19121606 | 98.41 | 99.50 | 98.90 | 99.20 | 94.73 |
| standing-water | 95802 | 4.30 | 11.09 | 6.57 | 8.25 | 14.12 |
| terrain | 39239306 | 86.92 | 87.89 | 98.74 | 93.00 | 60.59 |
| trackbed | 10643081 | 52.68 | 63.28 | 75.88 | 69.01 | 45.90 |
| traffic-light | 19510 | 42.60 | 86.15 | 45.73 | 59.75 | 61.73 |
| traffic-sign | 13285 | 39.35 | 76.25 | 44.84 | 56.47 | 61.60 |
| tram-track | 56179 | 8.60 | 74.97 | 8.85 | 15.83 | 29.69 |
| truck | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| vegetation-overgrowth | 5901821 | 7.66 | 86.77 | 7.75 | 14.24 | 37.98 |

### Full-run accounting

| Measurement | Value |
| --- | --- |
| Full GPU-reserved wall seconds, all recorded worker attempts | 2124.21 |
...
| Checkpoint / weights / split | Images | Mud IoU (%) | Mud precision (%) | Mud recall (%) |
| --- | --- | --- | --- | --- |
| best-auto-train / raw | 220 | 91.96 | 94.97 | 96.67 |
| best-auto-val / raw | 37 | 1.72 | 2.21 | 7.14 |
| best-alternate-val / ema | 37 | 0.64 | 0.88 | 2.23 |
| final-auto-val / raw | 37 | 0.30 | 0.56 | 0.62 |
...
```json
{
  ...
  "checkpoints": {
    "best": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/native_resnet18_fpn_segformer_aux--railsem19_to_rtis--seed-1_seed1/rtis/best.ckpt",
      "sha256": "ab50e15cc0b9d09d85891d8325708aed6595ad775cbaef8618d61c7c7bda58ca",
      "global_step": 2036,
      "bytes": 193887797
    },
    "final": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/native_resnet18_fpn_segformer_aux--railsem19_to_rtis--seed-1_seed1/rtis/last.ckpt",
      "sha256": "fd71125bc10d5613f6c9c3fddd426c5ec2bee7678338ee7d8365ead145b7b60d",
      "global_step": 3309,
      "bytes": 193882229
    }
  },
...
Status: **completed**. Started: 2026-09-06T22:03:57.146451+00:00. Finished: 2026-09-06T22:39:32.283648+00:00.
...
Config SHA-256: `ddc6f6198e1c3cfabaf841316e0c5314021b2ff97269ab7d0aee208b612f006b`. Weights used for validation: `raw`.
...
| --- | --- | --- |
| Mud IoU | 4.21 | 1.93 |
| Mud precision | 5.34 | 3.04 |
| Mud recall | 16.53 | 5.05 |
| Mud Dice/F1 | 8.08 | 3.79 |
| mIoU | 31.68 | 35.74 |
| Mean accuracy | 45.50 | 49.07 |
| Mean precision | 49.24 | 50.46 |
| Mean Dice | 40.35 | 45.01 |
| Mean specificity | 98.76 | 98.95 |
| Pixel accuracy | 80.68 | 83.17 |
| Frequency-weighted IoU | 70.37 | 74.05 |
| Fixed GT-present class mIoU | 36.96 | 39.71 |
| Boundary F1 | 34.39 | 39.26 |
...
| Peak training VRAM, retained training invocation (GiB) | 7.76 |
| Peak evaluation VRAM (GiB) | 6.87 |
| Retained training invocation wall time (seconds) | 2009.96 |
| Retained training invocation GPU-hours (one GPU) | 0.56 |
...
| Status | Parameters | Weight MiB | FPS | p50 ms | p95 ms | Peak reserved GiB |
| --- | --- | --- | --- | --- | --- | --- |
| complete | 12100522 | 46.16 | 224.68 | 4.35 | 5.18 | 0.61 |

```json
{
  "schema_version": 1,
  "model_id": "native_resnet18_fpn_segformer_aux",
  "measured_at": "2026-09-06T22:39:29+00:00",
  "status": "complete",
  "benchmark_scope": "rtis_selected_checkpoint_model_only",
  "applies_to": [
    "native_resnet18_fpn_segformer_aux--cityscapes_to_railsem19_to_rtis--seed-1"
  ],
  "source": {
    "campaign_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "git_dirty": false,
    "config_hash": "d8c51c4d9c6c",
    "resolved_config": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/configs/native_resnet18_fpn_segformer_aux--cityscapes_to_railsem19_to_rtis--seed-1.yaml",
    "config_sha256": "ddc6f6198e1c3cfabaf841316e0c5314021b2ff97269ab7d0aee208b612f006b",
    "checkpoint_sha256": "92e926fb498b2a882fc28d92e3ee882a628337d04771e4729209e706266a2ddd",
    "checkpoint_global_step": 2036,
    "checkpoint_bytes": 193887861,
    "checkpoint_kind": "resume checkpoint with optimizer and EMA state",
    "weights": "raw",
    "measured_checkpoint_job_id": "native_resnet18_fpn_segformer_aux--cityscapes_to_railsem19_to_rtis--seed-1",
    "result_sha256": "99b5dc98892a73feddb6eed5636541359c6ad5214b69e510898757122b6a26f1",
    "result_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "result_stage": "eval:paul-test-rtis:val",
    "result_seed": 1
  },
  ...
  "measurements": {
    "latency": {
      "p50_ms": 4.3479039669036865,
      "p95_ms": 5.178470492362976,
      "mean_ms": 4.450815682411194,
      "minimum_ms": 3.8195199966430664,
      "maximum_ms": 6.964191913604736,
      "fps": 224.67791779197157,
      "raw_ms": [
        4.331520080566406,
        3.9567360877990723,
        4.255743980407715,
    ...
    "peak_reserved_bytes": 656408576,
    "memory_kind": "pytorch_cuda_allocator_peak_reserved_excluding_context",
    "benchmark_wall_clock_s": 10.736544255167246
  },
  "started_at": "2026-09-06T22:39:18+00:00",
  "finished_at": "2026-09-06T22:39:29+00:00",
  "environment": {
    "hostname": "hdrfs-app-001",
    "python": "3.11.15",
    "platform": "Linux-5.15.0-139-generic-x86_64-with-glibc2.35",
...
| Class | GT pixels | IoU (%) | Precision (%) | Recall (%) | Dice (%) | Boundary F1 (%) |
| --- | --- | --- | --- | --- | --- | --- |
| car | 29664 | 38.74 | 70.10 | 46.41 | 55.85 | 48.07 |
| construction | 311585 | 46.48 | 52.29 | 80.70 | 63.46 | 46.62 |
| fence | 265137 | 4.59 | 14.04 | 6.39 | 8.78 | 15.68 |
| mud-pumping | 1226250 | 4.21 | 5.34 | 16.53 | 8.08 | 8.52 |
| on-rails | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| person | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| pole | 628038 | 68.86 | 79.74 | 83.46 | 81.56 | 86.57 |
| rail-embedded | 16799 | 1.14 | 7.86 | 1.31 | 2.25 | 5.39 |
| rail-raised | 2969797 | 68.28 | 79.64 | 82.72 | 81.15 | 85.73 |
| rail-track | 6323197 | 32.77 | 75.83 | 36.59 | 49.36 | 44.35 |
| road | 1048831 | 6.48 | 34.44 | 7.39 | 12.17 | 16.04 |
| sidewalk | 1297367 | 39.88 | 91.70 | 41.38 | 57.02 | 15.07 |
| sky | 19121606 | 95.88 | 99.44 | 96.40 | 97.90 | 82.82 |
| standing-water | 95802 | 0.19 | 0.57 | 0.29 | 0.39 | 2.34 |
| terrain | 39239306 | 84.48 | 85.48 | 98.63 | 91.59 | 51.78 |
| trackbed | 10643081 | 51.80 | 62.50 | 75.17 | 68.25 | 44.61 |
| traffic-light | 19510 | 59.38 | 80.88 | 69.07 | 74.51 | 60.55 |
| traffic-sign | 13285 | 42.44 | 67.85 | 53.12 | 59.59 | 58.01 |
| tram-track | 56179 | 12.64 | 35.77 | 16.35 | 22.44 | 18.51 |
| truck | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| vegetation-overgrowth | 5901821 | 7.01 | 90.62 | 7.06 | 13.11 | 31.53 |

### Full-run accounting

| Measurement | Value |
| --- | --- |
| Full GPU-reserved wall seconds, all recorded worker attempts | 2135.30 |
| Full reserved GPU-hours | 0.59 |
| Whole-run timing complete | True |
...
| Checkpoint / weights / split | Images | Mud IoU (%) | Mud precision (%) | Mud recall (%) |
| --- | --- | --- | --- | --- |
| best-auto-train / raw | 220 | 90.84 | 94.59 | 95.82 |
| best-auto-val / raw | 37 | 4.21 | 5.34 | 16.53 |
| best-alternate-val / ema | 37 | 1.75 | 2.39 | 6.12 |
| final-auto-val / raw | 37 | 1.93 | 3.04 | 5.05 |
...
```json
{
  ...
  "checkpoints": {
    "best": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/native_resnet18_fpn_segformer_aux--cityscapes_to_railsem19_to_rtis--seed-1_seed1/rtis/best.ckpt",
      "sha256": "92e926fb498b2a882fc28d92e3ee882a628337d04771e4729209e706266a2ddd",
      "global_step": 2036,
      "bytes": 193887861
    },
    "final": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/native_resnet18_fpn_segformer_aux--cityscapes_to_railsem19_to_rtis--seed-1_seed1/rtis/last.ckpt",
      "sha256": "dcf067f0ac00be1f19b7226f60f9e2f3a76c2e35a336eed450853a4071a8e488",
      "global_step": 3309,
      "bytes": 193882293
    }
  },
...
Status: **completed**. Started: 2026-09-06T22:11:04.759467+00:00. Finished: 2026-09-06T22:37:05.805971+00:00.
...
Config SHA-256: `91052bd3f40328ebcb14ddcb64bccc50fcb0a3d2247f739c409b4d57255f604f`. Weights used for validation: `raw`.
...
| --- | --- | --- |
| Mud IoU | 4.81 | 2.17 |
| Mud precision | 7.12 | 3.45 |
| Mud recall | 12.87 | 5.50 |
| Mud Dice/F1 | 9.17 | 4.24 |
| mIoU | 30.94 | 34.59 |
| Mean accuracy | 41.10 | 49.34 |
| Mean precision | 49.33 | 47.91 |
| Mean Dice | 38.82 | 43.13 |
| Mean specificity | 98.72 | 98.97 |
| Pixel accuracy | 80.76 | 82.63 |
| Frequency-weighted IoU | 69.81 | 74.07 |
| Fixed GT-present class mIoU | 34.38 | 40.35 |
| Boundary F1 | 36.62 | 37.36 |
...
| Peak training VRAM, retained training invocation (GiB) | 7.76 |
| Peak evaluation VRAM (GiB) | 6.87 |
| Retained training invocation wall time (seconds) | 1436.73 |
...
| Status | Parameters | Weight MiB | FPS | p50 ms | p95 ms | Peak reserved GiB |
| --- | --- | --- | --- | --- | --- | --- |
| complete | 12100522 | 46.16 | 251.43 | 3.91 | 4.27 | 0.61 |

```json
{
  "schema_version": 1,
  "model_id": "native_resnet18_fpn_segformer_aux",
  "measured_at": "2026-09-06T22:37:03+00:00",
  "status": "complete",
  "benchmark_scope": "rtis_selected_checkpoint_model_only",
  "applies_to": [
    "native_resnet18_fpn_segformer_aux--cityscapes_to_railsem19_to_rtis--seed-2"
  ],
  "source": {
    "campaign_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "git_dirty": false,
    "config_hash": "48edcb3d6135",
    "resolved_config": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/configs/native_resnet18_fpn_segformer_aux--cityscapes_to_railsem19_to_rtis--seed-2.yaml",
    "config_sha256": "91052bd3f40328ebcb14ddcb64bccc50fcb0a3d2247f739c409b4d57255f604f",
    "checkpoint_sha256": "7cec4bbb5e2d919b9e7707a1f370c17ee5c1f7c3022f5bf55e709b072df3e07a",
    "checkpoint_global_step": 1018,
    "checkpoint_bytes": 193887861,
    "checkpoint_kind": "resume checkpoint with optimizer and EMA state",
    "weights": "raw",
    "measured_checkpoint_job_id": "native_resnet18_fpn_segformer_aux--cityscapes_to_railsem19_to_rtis--seed-2",
    "result_sha256": "f02ddef0db9fb33c6a1dc7beb39f151be48625b333bf147cf9bb32c116a1f4e8",
    "result_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "result_stage": "eval:paul-test-rtis:val",
    "result_seed": 2
  },
  ...
  "measurements": {
    "latency": {
      "p50_ms": 3.9137120246887207,
      "p95_ms": 4.268083262443542,
      "mean_ms": 3.9772198390960694,
      "minimum_ms": 3.8143999576568604,
      "maximum_ms": 4.490240097045898,
      "fps": 251.43191486927637,
      "raw_ms": [
        4.490240097045898,
        4.409279823303223,
        3.9188480377197266,
    ...
    "peak_reserved_bytes": 656408576,
    "memory_kind": "pytorch_cuda_allocator_peak_reserved_excluding_context",
    "benchmark_wall_clock_s": 10.868661746382713
  },
  "started_at": "2026-09-06T22:36:52+00:00",
  "finished_at": "2026-09-06T22:37:03+00:00",
  "environment": {
    "hostname": "hdrfs-app-001",
    "python": "3.11.15",
    "platform": "Linux-5.15.0-139-generic-x86_64-with-glibc2.35",
...
| Class | GT pixels | IoU (%) | Precision (%) | Recall (%) | Dice (%) | Boundary F1 (%) |
| --- | --- | --- | --- | --- | --- | --- |
| car | 29664 | 3.33 | 25.71 | 3.68 | 6.44 | 31.88 |
| construction | 311585 | 50.02 | 61.10 | 73.39 | 66.68 | 53.99 |
| fence | 265137 | 5.44 | 23.14 | 6.64 | 10.32 | 17.00 |
| mud-pumping | 1226250 | 4.81 | 7.12 | 12.87 | 9.17 | 9.88 |
| on-rails | 0 | — | — | — | — | — |
| person | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| pole | 628038 | 68.41 | 84.39 | 78.32 | 81.24 | 87.46 |
| rail-embedded | 16799 | 1.94 | 7.93 | 2.51 | 3.82 | 6.58 |
| rail-raised | 2969797 | 68.65 | 77.68 | 85.53 | 81.41 | 86.34 |
| rail-track | 6323197 | 34.87 | 73.94 | 39.76 | 51.71 | 51.41 |
| road | 1048831 | 6.90 | 22.69 | 9.03 | 12.92 | 15.64 |
| sidewalk | 1297367 | 24.27 | 96.51 | 24.49 | 39.07 | 8.44 |
| sky | 19121606 | 97.62 | 99.38 | 98.21 | 98.79 | 91.86 |
| standing-water | 95802 | 0.70 | 0.83 | 4.44 | 1.40 | 3.52 |
| terrain | 39239306 | 82.08 | 83.43 | 98.06 | 90.16 | 47.07 |
| trackbed | 10643081 | 51.72 | 63.73 | 73.29 | 68.18 | 46.65 |
| traffic-light | 19510 | 73.07 | 87.63 | 81.48 | 84.44 | 67.57 |
| traffic-sign | 13285 | 34.42 | 82.21 | 37.18 | 51.21 | 63.57 |
| tram-track | 56179 | 0.60 | 2.18 | 0.82 | 1.19 | 5.80 |
| truck | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| vegetation-overgrowth | 5901821 | 10.04 | 86.98 | 10.19 | 18.24 | 37.71 |

### Full-run accounting

| Measurement | Value |
| --- | --- |
| Full GPU-reserved wall seconds, all recorded worker attempts | 1561.19 |
| Full reserved GPU-hours | 0.43 |
| Whole-run timing complete | True |
...
| Checkpoint / weights / split | Images | Mud IoU (%) | Mud precision (%) | Mud recall (%) |
| --- | --- | --- | --- | --- |
| best-auto-train / raw | 220 | 88.84 | 93.62 | 94.57 |
| best-auto-val / raw | 37 | 4.81 | 7.12 | 12.87 |
| best-alternate-val / ema | 37 | 3.02 | 4.71 | 7.79 |
| final-auto-val / raw | 37 | 2.16 | 3.45 | 5.50 |
...
```json
{
  ...
  "checkpoints": {
    "best": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/native_resnet18_fpn_segformer_aux--cityscapes_to_railsem19_to_rtis--seed-2_seed2/rtis/best.ckpt",
      "sha256": "7cec4bbb5e2d919b9e7707a1f370c17ee5c1f7c3022f5bf55e709b072df3e07a",
      "global_step": 1018,
      "bytes": 193887861
    },
    "final": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/native_resnet18_fpn_segformer_aux--cityscapes_to_railsem19_to_rtis--seed-2_seed2/rtis/last.ckpt",
      "sha256": "794ad143d9e794c4ebb576e8e5571b705b498ca54aeed7fabc2406c1bdddc636",
      "global_step": 2290,
      "bytes": 193882293
    }
  },
