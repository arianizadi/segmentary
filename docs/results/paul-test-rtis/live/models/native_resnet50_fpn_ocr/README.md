...
| native_resnet50_fpn_ocr | railsem19_to_rtis | 2 | completed | 2800 | 1527 | 6.74 | 30.84 | 7.94 | 0.62 | 42.16 | 46.84 |
| native_resnet50_fpn_ocr | cityscapes_to_railsem19_to_rtis | 0 | completed | 1781 | 509 | 2.29 | 2.94 | 9.47 | 1.21 | 36.84 | 42.97 |
| native_resnet50_fpn_ocr | cityscapes_to_railsem19_to_rtis | 1 | completed | 2036 | 763 | 1.41 | 1.98 | 4.62 | 1.02 | 38.91 | 45.39 |
| native_resnet50_fpn_ocr | cityscapes_to_railsem19_to_rtis | 2 | completed | 2290 | 1018 | 3.41 | 43.16 | 3.57 | 0.87 | 36.42 | 42.49 |
...
Status: **completed**. Started: 2026-09-06T23:56:22.270352+00:00. Finished: 2026-09-07T00:58:49.321965+00:00.
...
Config SHA-256: `b6923f44342a4da15b17e23fd1637e2d42da514ff2983621380e3bb867d0aae9`. Weights used for validation: `raw`.
...
| --- | --- | --- |
| Mud IoU | 6.74 | 0.62 |
| Mud precision | 30.84 | 17.89 |
| Mud recall | 7.94 | 0.64 |
| Mud Dice/F1 | 12.62 | 1.24 |
| mIoU | 42.16 | 38.42 |
| Mean accuracy | 55.73 | 54.10 |
| Mean precision | 62.74 | 55.41 |
| Mean Dice | 53.32 | 48.70 |
| Mean specificity | 99.11 | 99.18 |
| Pixel accuracy | 85.49 | 86.35 |
| Frequency-weighted IoU | 76.84 | 77.96 |
| Fixed GT-present class mIoU | 46.84 | 44.83 |
| Boundary F1 | 47.79 | 45.53 |
...
| Peak training VRAM, retained training invocation (GiB) | 11.64 |
| Peak evaluation VRAM (GiB) | 7.02 |
| Retained training invocation wall time (seconds) | 3556.86 |
| Retained training invocation GPU-hours (one GPU) | 0.99 |
| Evaluation wall time (seconds) | 17.36 |
| Full evaluation pipeline images/second | 2.13 |
| Best full-state checkpoint (MiB) | 498.97 |
| Final full-state checkpoint (MiB) | 498.96 |
| Audited periodic checkpoints removed (GiB) | 2.44 |
...
| Status | Parameters | Weight MiB | FPS | p50 ms | p95 ms | Peak reserved GiB |
| --- | --- | --- | --- | --- | --- | --- |
| complete | 32646762 | 124.54 | 47.71 | 20.91 | 21.76 | 1.46 |

```json
{
  "schema_version": 1,
  "model_id": "native_resnet50_fpn_ocr",
  "measured_at": "2026-09-07T00:58:44+00:00",
  "status": "complete",
  "benchmark_scope": "rtis_selected_checkpoint_model_only",
  "applies_to": [
    "native_resnet50_fpn_ocr--railsem19_to_rtis--seed-2"
  ],
  "source": {
    "campaign_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "git_dirty": false,
    "config_hash": "2e257b645fc1",
    "resolved_config": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/configs/native_resnet50_fpn_ocr--railsem19_to_rtis--seed-2.yaml",
    "config_sha256": "b6923f44342a4da15b17e23fd1637e2d42da514ff2983621380e3bb867d0aae9",
    "checkpoint_sha256": "ab24404a359d7b4b7ea4ec829a06ef56b52be33c2c57a1952fe595b632807be7",
    "checkpoint_global_step": 1527,
    "checkpoint_bytes": 523207337,
    "checkpoint_kind": "resume checkpoint with optimizer and EMA state",
    "weights": "raw",
    "measured_checkpoint_job_id": "native_resnet50_fpn_ocr--railsem19_to_rtis--seed-2",
    "result_sha256": "3da2ccef6c68acdeb1ff2531dd793d0cf9b17cf1b3eefa7f887ffc1fef909715",
    "result_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "result_stage": "eval:paul-test-rtis:val",
    "result_seed": 2
  },
  ...
  "measurements": {
    "latency": {
      "p50_ms": 20.911104202270508,
      "p95_ms": 21.763738250732423,
      "mean_ms": 20.961593894958497,
      "minimum_ms": 20.545536041259766,
      "maximum_ms": 22.125568389892578,
      "fps": 47.70629585761183,
      "raw_ms": [
        21.357568740844727,
        20.545536041259766,
        20.690847396850586,
    ...
    "peak_reserved_bytes": 1562378240,
    "memory_kind": "pytorch_cuda_allocator_peak_reserved_excluding_context",
    "benchmark_wall_clock_s": 15.958313506096601
  },
  "started_at": "2026-09-07T00:58:28+00:00",
  "finished_at": "2026-09-07T00:58:44+00:00",
  "environment": {
    "hostname": "hdrfs-app-001",
    "python": "3.11.15",
    "platform": "Linux-5.15.0-139-generic-x86_64-with-glibc2.35",
...
| Class | GT pixels | IoU (%) | Precision (%) | Recall (%) | Dice (%) | Boundary F1 (%) |
| --- | --- | --- | --- | --- | --- | --- |
| car | 29664 | 65.28 | 70.40 | 89.98 | 78.99 | 55.34 |
| construction | 311585 | 57.04 | 67.64 | 78.46 | 72.65 | 64.25 |
| fence | 265137 | 13.48 | 68.09 | 14.39 | 23.75 | 36.02 |
| mud-pumping | 1226250 | 6.74 | 30.84 | 7.94 | 12.62 | 13.82 |
| on-rails | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| person | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| pole | 628038 | 74.26 | 85.72 | 84.75 | 85.23 | 90.89 |
| rail-embedded | 16799 | 31.60 | 86.69 | 33.22 | 48.03 | 59.43 |
| rail-raised | 2969797 | 74.76 | 82.83 | 88.48 | 85.56 | 89.27 |
| rail-track | 6323197 | 40.87 | 60.95 | 55.37 | 58.02 | 54.19 |
| road | 1048831 | 26.03 | 59.79 | 31.55 | 41.30 | 27.72 |
| sidewalk | 1297367 | 39.48 | 62.76 | 51.55 | 56.61 | 10.86 |
| sky | 19121606 | 98.19 | 99.38 | 98.80 | 99.09 | 94.12 |
| standing-water | 95802 | 0.00 | 0.00 | 0.01 | 0.00 | 0.01 |
| terrain | 39239306 | 89.65 | 91.19 | 98.14 | 94.54 | 67.94 |
| trackbed | 10643081 | 55.12 | 65.40 | 77.82 | 71.07 | 52.37 |
| traffic-light | 19510 | 46.04 | 81.29 | 51.50 | 63.05 | 69.19 |
| traffic-sign | 13285 | 45.71 | 70.11 | 56.78 | 62.74 | 61.87 |
| tram-track | 56179 | 39.71 | 85.30 | 42.63 | 56.85 | 42.68 |
| truck | 0 | — | — | — | — | — |
| vegetation-overgrowth | 5901821 | 39.22 | 86.48 | 41.79 | 56.35 | 65.86 |

### Full-run accounting

| Measurement | Value |
| --- | --- |
| Full GPU-reserved wall seconds, all recorded worker attempts | 3747.45 |
...
| Checkpoint / weights / split | Images | Mud IoU (%) | Mud precision (%) | Mud recall (%) |
| --- | --- | --- | --- | --- |
| best-auto-train / raw | 220 | 93.80 | 96.43 | 97.18 |
| best-auto-val / raw | 37 | 6.74 | 30.84 | 7.94 |
| best-alternate-val / ema | 37 | 0.97 | 49.82 | 0.98 |
| final-auto-val / raw | 37 | 0.62 | 17.72 | 0.64 |
...
```json
{
  ...
  "checkpoints": {
    "best": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/native_resnet50_fpn_ocr--railsem19_to_rtis--seed-2_seed2/rtis/best.ckpt",
      "sha256": "ab24404a359d7b4b7ea4ec829a06ef56b52be33c2c57a1952fe595b632807be7",
      "global_step": 1527,
      "bytes": 523207337
    },
    "final": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/native_resnet50_fpn_ocr--railsem19_to_rtis--seed-2_seed2/rtis/last.ckpt",
      "sha256": "7d4c9bde1c7bf842b642843f63ec2024a72c1fa898684ed3e640128def7e9945",
      "global_step": 2800,
      "bytes": 523195113
    }
  },
...
Status: **completed**. Started: 2026-09-07T00:12:37.802225+00:00. Finished: 2026-09-07T00:59:10.382104+00:00.
...
Config SHA-256: `c93629634dc5b487a6f19d0da242ce5e7a2b469cd710a25b66784721bae42be2`. Weights used for validation: `raw`.
...
| --- | --- | --- |
| Mud IoU | 1.41 | 1.02 |
| Mud precision | 1.98 | 21.11 |
| Mud recall | 4.62 | 1.06 |
| Mud Dice/F1 | 2.78 | 2.02 |
| mIoU | 38.91 | 38.60 |
| Mean accuracy | 52.75 | 50.31 |
| Mean precision | 58.06 | 56.82 |
| Mean Dice | 48.75 | 48.20 |
| Mean specificity | 98.91 | 99.00 |
| Pixel accuracy | 82.94 | 84.38 |
| Frequency-weighted IoU | 73.44 | 74.54 |
| Fixed GT-present class mIoU | 45.39 | 42.89 |
| Boundary F1 | 44.37 | 46.33 |
...
| Peak training VRAM, retained training invocation (GiB) | 11.64 |
| Peak evaluation VRAM (GiB) | 7.02 |
| Retained training invocation wall time (seconds) | 2602.89 |
| Retained training invocation GPU-hours (one GPU) | 0.72 |
| Evaluation wall time (seconds) | 17.11 |
| Full evaluation pipeline images/second | 2.16 |
| Best full-state checkpoint (MiB) | 498.97 |
| Final full-state checkpoint (MiB) | 498.96 |
| Audited periodic checkpoints removed (GiB) | 1.95 |
...
| Status | Parameters | Weight MiB | FPS | p50 ms | p95 ms | Peak reserved GiB |
| --- | --- | --- | --- | --- | --- | --- |
| complete | 32646762 | 124.54 | 47.52 | 20.92 | 21.60 | 1.46 |

```json
{
  "schema_version": 1,
  "model_id": "native_resnet50_fpn_ocr",
  "measured_at": "2026-09-07T00:59:05+00:00",
  "status": "complete",
  "benchmark_scope": "rtis_selected_checkpoint_model_only",
  "applies_to": [
    "native_resnet50_fpn_ocr--cityscapes_to_railsem19_to_rtis--seed-1"
  ],
  "source": {
    "campaign_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "git_dirty": false,
    "config_hash": "098f4c1e885d",
    "resolved_config": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/configs/native_resnet50_fpn_ocr--cityscapes_to_railsem19_to_rtis--seed-1.yaml",
    "config_sha256": "c93629634dc5b487a6f19d0da242ce5e7a2b469cd710a25b66784721bae42be2",
    "checkpoint_sha256": "a4ec4f9709312dd473e3b5758fffd007b3213360f07753bd2b19967717535146",
    "checkpoint_global_step": 763,
    "checkpoint_bytes": 523207401,
    "checkpoint_kind": "resume checkpoint with optimizer and EMA state",
    "weights": "raw",
    "measured_checkpoint_job_id": "native_resnet50_fpn_ocr--cityscapes_to_railsem19_to_rtis--seed-1",
    "result_sha256": "8bf4de6e854640980a54455792ac41f6ebb7f97451aa7a5450639424eceab629",
    "result_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "result_stage": "eval:paul-test-rtis:val",
    "result_seed": 1
  },
  ...
  "measurements": {
    "latency": {
      "p50_ms": 20.916287422180176,
      "p95_ms": 21.599538707733153,
      "mean_ms": 21.041775283813475,
      "minimum_ms": 20.708351135253906,
      "maximum_ms": 22.225919723510742,
      "fps": 47.524507153598236,
      "raw_ms": [
        21.326847076416016,
        20.832256317138672,
        20.762624740600586,
    ...
    "peak_reserved_bytes": 1562378240,
    "memory_kind": "pytorch_cuda_allocator_peak_reserved_excluding_context",
    "benchmark_wall_clock_s": 15.541577942669392
  },
  "started_at": "2026-09-07T00:58:50+00:00",
  "finished_at": "2026-09-07T00:59:05+00:00",
  "environment": {
    "hostname": "hdrfs-app-001",
    "python": "3.11.15",
    "platform": "Linux-5.15.0-139-generic-x86_64-with-glibc2.35",
...
| Class | GT pixels | IoU (%) | Precision (%) | Recall (%) | Dice (%) | Boundary F1 (%) |
| --- | --- | --- | --- | --- | --- | --- |
| car | 29664 | 32.77 | 68.30 | 38.65 | 49.36 | 37.70 |
| construction | 311585 | 58.36 | 74.55 | 72.88 | 73.70 | 61.63 |
| fence | 265137 | 13.01 | 55.06 | 14.55 | 23.02 | 30.04 |
| mud-pumping | 1226250 | 1.41 | 1.98 | 4.62 | 2.78 | 2.24 |
| on-rails | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| person | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| pole | 628038 | 74.75 | 85.08 | 86.04 | 85.55 | 90.87 |
| rail-embedded | 16799 | 25.07 | 51.03 | 33.02 | 40.09 | 55.24 |
| rail-raised | 2969797 | 73.82 | 81.60 | 88.56 | 84.94 | 88.03 |
| rail-track | 6323197 | 33.84 | 70.11 | 39.55 | 50.57 | 48.18 |
| road | 1048831 | 30.28 | 47.66 | 45.37 | 46.49 | 29.44 |
| sidewalk | 1297367 | 46.66 | 85.35 | 50.72 | 63.63 | 15.26 |
| sky | 19121606 | 98.12 | 99.52 | 98.59 | 99.05 | 93.50 |
| standing-water | 95802 | 0.11 | 0.46 | 0.14 | 0.21 | 0.55 |
| terrain | 39239306 | 85.65 | 86.85 | 98.42 | 92.27 | 58.29 |
| trackbed | 10643081 | 58.41 | 69.29 | 78.81 | 73.75 | 52.65 |
| traffic-light | 19510 | 80.88 | 91.59 | 87.38 | 89.43 | 93.29 |
| traffic-sign | 13285 | 50.31 | 90.81 | 53.01 | 66.95 | 70.83 |
| tram-track | 56179 | 38.20 | 76.56 | 43.26 | 55.28 | 48.82 |
| truck | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| vegetation-overgrowth | 5901821 | 15.43 | 83.49 | 15.92 | 26.74 | 55.30 |

### Full-run accounting

| Measurement | Value |
| --- | --- |
| Full GPU-reserved wall seconds, all recorded worker attempts | 2792.95 |
| Full reserved GPU-hours | 0.78 |
| Whole-run timing complete | True |
...
| Checkpoint / weights / split | Images | Mud IoU (%) | Mud precision (%) | Mud recall (%) |
| --- | --- | --- | --- | --- |
| best-auto-train / raw | 220 | 92.27 | 96.54 | 95.43 |
| best-auto-val / raw | 37 | 1.41 | 1.98 | 4.62 |
| best-alternate-val / ema | 37 | 2.31 | 5.65 | 3.75 |
| final-auto-val / raw | 37 | 1.02 | 20.80 | 1.06 |
...
```json
{
  ...
  "checkpoints": {
    "best": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/native_resnet50_fpn_ocr--cityscapes_to_railsem19_to_rtis--seed-1_seed1/rtis/best.ckpt",
      "sha256": "a4ec4f9709312dd473e3b5758fffd007b3213360f07753bd2b19967717535146",
      "global_step": 763,
      "bytes": 523207401
    },
    "final": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/native_resnet50_fpn_ocr--cityscapes_to_railsem19_to_rtis--seed-1_seed1/rtis/last.ckpt",
      "sha256": "4bb9a70caee9b701389006de7c8cfde1f907b3303a6858bb165b5908f5dbb725",
      "global_step": 2036,
      "bytes": 523195177
    }
  },
...
Status: **completed**. Started: 2026-09-07T00:14:15.637160+00:00. Finished: 2026-09-07T01:06:02.885315+00:00.
...
Config SHA-256: `e5190b1cd1c6a3f4f7affd4baf6cc4e5b445b96074440bb0146db7064f38e13e`. Weights used for validation: `raw`.
...
| --- | --- | --- |
| Mud IoU | 3.41 | 0.87 |
| Mud precision | 43.16 | 22.74 |
| Mud recall | 3.57 | 0.89 |
| Mud Dice/F1 | 6.60 | 1.72 |
| mIoU | 36.42 | 37.92 |
| Mean accuracy | 48.83 | 52.53 |
| Mean precision | 59.99 | 56.33 |
| Mean Dice | 46.05 | 47.75 |
| Mean specificity | 98.96 | 99.09 |
| Pixel accuracy | 84.09 | 85.43 |
| Frequency-weighted IoU | 73.85 | 76.36 |
| Fixed GT-present class mIoU | 42.49 | 44.24 |
| Boundary F1 | 44.44 | 45.31 |
...
| Peak training VRAM, retained training invocation (GiB) | 11.64 |
| Peak evaluation VRAM (GiB) | 7.02 |
| Retained training invocation wall time (seconds) | 2917.68 |
| Retained training invocation GPU-hours (one GPU) | 0.81 |
| Evaluation wall time (seconds) | 16.98 |
| Full evaluation pipeline images/second | 2.18 |
| Best full-state checkpoint (MiB) | 498.97 |
| Final full-state checkpoint (MiB) | 498.96 |
| Audited periodic checkpoints removed (GiB) | 1.95 |
...
| Status | Parameters | Weight MiB | FPS | p50 ms | p95 ms | Peak reserved GiB |
| --- | --- | --- | --- | --- | --- | --- |
| complete | 32646762 | 124.54 | 47.38 | 21.08 | 21.86 | 1.46 |

```json
{
  "schema_version": 1,
  "model_id": "native_resnet50_fpn_ocr",
  "measured_at": "2026-09-07T01:05:58+00:00",
  "status": "complete",
  "benchmark_scope": "rtis_selected_checkpoint_model_only",
  "applies_to": [
    "native_resnet50_fpn_ocr--cityscapes_to_railsem19_to_rtis--seed-2"
  ],
  "source": {
    "campaign_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "git_dirty": false,
    "config_hash": "f5163ea15d91",
    "resolved_config": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/configs/native_resnet50_fpn_ocr--cityscapes_to_railsem19_to_rtis--seed-2.yaml",
    "config_sha256": "e5190b1cd1c6a3f4f7affd4baf6cc4e5b445b96074440bb0146db7064f38e13e",
    "checkpoint_sha256": "0b83e0d6d5f6abf26193725141adf16b6049f56e0021e5f7dfc799e215bbe5fd",
    "checkpoint_global_step": 1018,
    "checkpoint_bytes": 523207401,
    "checkpoint_kind": "resume checkpoint with optimizer and EMA state",
    "weights": "raw",
    "measured_checkpoint_job_id": "native_resnet50_fpn_ocr--cityscapes_to_railsem19_to_rtis--seed-2",
    "result_sha256": "a6157e2d0cf2a9b72369ad5c0a82edf74dcd8bbbceec184a30303925c68b6b56",
    "result_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "result_stage": "eval:paul-test-rtis:val",
    "result_seed": 2
  },
  ...
  "measurements": {
    "latency": {
      "p50_ms": 21.081600189208984,
      "p95_ms": 21.85559015274048,
      "mean_ms": 21.105520362854005,
      "minimum_ms": 20.516864776611328,
      "maximum_ms": 23.53049659729004,
      "fps": 47.380968713759515,
      "raw_ms": [
        21.08723258972168,
        21.138431549072266,
        21.329919815063477,
    ...
    "peak_reserved_bytes": 1562378240,
    "memory_kind": "pytorch_cuda_allocator_peak_reserved_excluding_context",
    "benchmark_wall_clock_s": 15.907627832144499
  },
  "started_at": "2026-09-07T01:05:42+00:00",
  "finished_at": "2026-09-07T01:05:58+00:00",
  "environment": {
    "hostname": "hdrfs-app-001",
    "python": "3.11.15",
    "platform": "Linux-5.15.0-139-generic-x86_64-with-glibc2.35",
...
| Class | GT pixels | IoU (%) | Precision (%) | Recall (%) | Dice (%) | Boundary F1 (%) |
| --- | --- | --- | --- | --- | --- | --- |
| car | 29664 | 4.64 | 24.88 | 5.39 | 8.86 | 28.85 |
| construction | 311585 | 63.81 | 78.10 | 77.72 | 77.91 | 73.80 |
| fence | 265137 | 18.16 | 72.42 | 19.51 | 30.74 | 42.79 |
| mud-pumping | 1226250 | 3.41 | 43.16 | 3.57 | 6.60 | 5.27 |
| on-rails | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| person | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| pole | 628038 | 73.18 | 86.13 | 82.96 | 84.52 | 91.76 |
| rail-embedded | 16799 | 29.56 | 83.64 | 31.37 | 45.63 | 56.22 |
| rail-raised | 2969797 | 77.21 | 83.40 | 91.23 | 87.14 | 90.37 |
| rail-track | 6323197 | 34.21 | 70.78 | 39.84 | 50.98 | 47.49 |
| road | 1048831 | 8.51 | 55.07 | 9.14 | 15.68 | 19.36 |
| sidewalk | 1297367 | 47.01 | 89.49 | 49.76 | 63.95 | 16.19 |
| sky | 19121606 | 98.20 | 99.38 | 98.81 | 99.09 | 94.87 |
| standing-water | 95802 | 0.05 | 1.07 | 0.06 | 0.11 | 2.05 |
| terrain | 39239306 | 86.44 | 87.69 | 98.38 | 92.73 | 60.71 |
| trackbed | 10643081 | 52.51 | 58.51 | 83.67 | 68.86 | 50.69 |
| traffic-light | 19510 | 51.80 | 81.90 | 58.49 | 68.24 | 64.96 |
| traffic-sign | 13285 | 45.98 | 76.53 | 53.53 | 62.99 | 64.47 |
| tram-track | 56179 | 42.27 | 83.68 | 46.07 | 59.42 | 58.14 |
| truck | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| vegetation-overgrowth | 5901821 | 27.84 | 84.00 | 29.40 | 43.55 | 65.34 |

### Full-run accounting

| Measurement | Value |
| --- | --- |
| Full GPU-reserved wall seconds, all recorded worker attempts | 3107.61 |
| Full reserved GPU-hours | 0.86 |
| Whole-run timing complete | True |
...
| Checkpoint / weights / split | Images | Mud IoU (%) | Mud precision (%) | Mud recall (%) |
| --- | --- | --- | --- | --- |
| best-auto-train / raw | 220 | 93.16 | 97.67 | 95.28 |
| best-auto-val / raw | 37 | 3.41 | 43.16 | 3.57 |
| best-alternate-val / ema | 37 | 1.85 | 6.10 | 2.58 |
| final-auto-val / raw | 37 | 0.86 | 22.68 | 0.89 |
...
```json
{
  ...
  "checkpoints": {
    "best": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/native_resnet50_fpn_ocr--cityscapes_to_railsem19_to_rtis--seed-2_seed2/rtis/best.ckpt",
      "sha256": "0b83e0d6d5f6abf26193725141adf16b6049f56e0021e5f7dfc799e215bbe5fd",
      "global_step": 1018,
      "bytes": 523207401
    },
    "final": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/native_resnet50_fpn_ocr--cityscapes_to_railsem19_to_rtis--seed-2_seed2/rtis/last.ckpt",
      "sha256": "b90853b9f30377c11dec5fa375d5fc82275cb37e0ce7c73e39a1d5c11304f5d2",
      "global_step": 2290,
      "bytes": 523195177
    }
  },
