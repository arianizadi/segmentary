...
| smp_upernet_mit_b0 | cityscapes_to_rtis | 1 | completed | 4000 | 2800 | 10.41 | 14.99 | 25.43 | 7.65 | 32.27 | 37.64 |
...
| smp_upernet_mit_b0 | railsem19_to_rtis | 2 | completed | 2800 | 1527 | 4.91 | 7.36 | 12.85 | 2.61 | 40.81 | 47.62 |
| smp_upernet_mit_b0 | cityscapes_to_railsem19_to_rtis | 0 | completed | 2545 | 1272 | 21.41 | 37.27 | 33.46 | 11.98 | 36.83 | 42.96 |
| smp_upernet_mit_b0 | cityscapes_to_railsem19_to_rtis | 1 | completed | 3054 | 1781 | 9.95 | 16.85 | 19.57 | 8.98 | 37.44 | 43.69 |
| smp_upernet_mit_b0 | cityscapes_to_railsem19_to_rtis | 2 | completed | 2800 | 1527 | 13.15 | 26.02 | 21.01 | 11.01 | 38.24 | 44.61 |
...
Status: **completed**. Started: 2026-09-07T10:43:24.093113+00:00. Finished: 2026-09-07T11:52:57.388159+00:00.
...
Config SHA-256: `3f167ac689f6565c20b9e43cb5a5333769c16d1eb02fe56168a139b27014f2b8`. Weights used for validation: `raw`.
...
| --- | --- | --- |
| Mud IoU | 10.41 | 7.65 |
| Mud precision | 14.99 | 11.27 |
| Mud recall | 25.43 | 19.24 |
| Mud Dice/F1 | 18.86 | 14.21 |
| mIoU | 32.27 | 32.03 |
| Mean accuracy | 46.73 | 46.77 |
| Mean precision | 50.30 | 50.30 |
| Mean Dice | 41.01 | 40.72 |
| Mean specificity | 98.81 | 98.84 |
| Pixel accuracy | 81.64 | 81.91 |
| Frequency-weighted IoU | 71.64 | 72.34 |
| Fixed GT-present class mIoU | 37.64 | 37.36 |
| Boundary F1 | 36.24 | 36.56 |
...
| Peak training VRAM, retained training invocation (GiB) | 11.14 |
| Peak evaluation VRAM (GiB) | 6.22 |
| Retained training invocation wall time (seconds) | 3989.30 |
| Retained training invocation GPU-hours (one GPU) | 1.11 |
| Evaluation wall time (seconds) | 18.01 |
| Full evaluation pipeline images/second | 2.05 |
| Best full-state checkpoint (MiB) | 164.26 |
| Final full-state checkpoint (MiB) | 164.25 |
| Audited periodic checkpoints removed (GiB) | 1.28 |
...
| Status | Parameters | Weight MiB | FPS | p50 ms | p95 ms | Peak reserved GiB |
| --- | --- | --- | --- | --- | --- | --- |
| complete | 10737525 | 40.96 | 54.10 | 18.42 | 18.75 | 1.09 |

```json
{
  "schema_version": 1,
  "model_id": "smp_upernet_mit_b0",
  "measured_at": "2026-09-07T11:52:54+00:00",
  "status": "complete",
  "benchmark_scope": "rtis_selected_checkpoint_model_only",
  "applies_to": [
    "smp_upernet_mit_b0--cityscapes_to_rtis--seed-1"
  ],
  "source": {
    "campaign_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "git_dirty": false,
    "config_hash": "e68a3dc356be",
    "resolved_config": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/configs/smp_upernet_mit_b0--cityscapes_to_rtis--seed-1.yaml",
    "config_sha256": "3f167ac689f6565c20b9e43cb5a5333769c16d1eb02fe56168a139b27014f2b8",
    "checkpoint_sha256": "096c3704d87ae3ec7feb894f501181636d70dc5e7cf0974fbc92d399d619cf75",
    "checkpoint_global_step": 2800,
    "checkpoint_bytes": 172236854,
    "checkpoint_kind": "resume checkpoint with optimizer and EMA state",
    "weights": "raw",
    "measured_checkpoint_job_id": "smp_upernet_mit_b0--cityscapes_to_rtis--seed-1",
    "result_sha256": "09f00a1744cc136e091cdfbdd6d2c13ca36d02a0324acccc1cf94db90fb77c5b",
    "result_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "result_stage": "eval:paul-test-rtis:val",
    "result_seed": 1
  },
  ...
  "measurements": {
    "latency": {
      "p50_ms": 18.41919994354248,
      "p95_ms": 18.75266561508179,
      "mean_ms": 18.484848957061768,
      "minimum_ms": 18.328575134277344,
      "maximum_ms": 18.86515235900879,
      "fps": 54.098359273742936,
      "raw_ms": [
        18.508800506591797,
        18.398208618164062,
        18.382848739624023,
    ...
    "peak_reserved_bytes": 1172307968,
    "memory_kind": "pytorch_cuda_allocator_peak_reserved_excluding_context",
    "benchmark_wall_clock_s": 9.193764217197895
  },
  "started_at": "2026-09-07T11:52:45+00:00",
  "finished_at": "2026-09-07T11:52:54+00:00",
  "environment": {
    "hostname": "hdrfs-app-001",
    "python": "3.11.15",
    "platform": "Linux-5.15.0-139-generic-x86_64-with-glibc2.35",
...
| Class | GT pixels | IoU (%) | Precision (%) | Recall (%) | Dice (%) | Boundary F1 (%) |
| --- | --- | --- | --- | --- | --- | --- |
| car | 29664 | 45.98 | 76.47 | 53.56 | 63.00 | 47.23 |
| construction | 311585 | 32.22 | 38.33 | 66.91 | 48.74 | 33.50 |
| fence | 265137 | 4.66 | 11.38 | 7.31 | 8.90 | 10.07 |
| mud-pumping | 1226250 | 10.41 | 14.99 | 25.43 | 18.86 | 12.86 |
| on-rails | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| person | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| pole | 628038 | 67.81 | 83.88 | 77.97 | 80.82 | 89.24 |
| rail-embedded | 16799 | 0.35 | 100.00 | 0.35 | 0.70 | 9.39 |
| rail-raised | 2969797 | 70.79 | 84.43 | 81.43 | 82.90 | 88.61 |
| rail-track | 6323197 | 34.10 | 66.16 | 41.31 | 50.86 | 46.46 |
| road | 1048831 | 9.19 | 29.41 | 11.79 | 16.83 | 11.31 |
| sidewalk | 1297367 | 29.49 | 66.34 | 34.68 | 45.55 | 15.96 |
| sky | 19121606 | 95.60 | 99.54 | 96.02 | 97.75 | 85.92 |
| standing-water | 95802 | 1.49 | 1.71 | 10.24 | 2.93 | 5.40 |
| terrain | 39239306 | 83.51 | 85.28 | 97.57 | 91.01 | 53.40 |
| trackbed | 10643081 | 48.20 | 64.85 | 65.25 | 65.05 | 50.23 |
| traffic-light | 19510 | 76.04 | 79.66 | 94.36 | 86.39 | 83.02 |
| traffic-sign | 13285 | 28.68 | 66.84 | 33.44 | 44.58 | 49.88 |
| tram-track | 56179 | 0.25 | 8.00 | 0.26 | 0.50 | 0.00 |
| truck | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| vegetation-overgrowth | 5901821 | 38.82 | 79.07 | 43.26 | 55.93 | 68.53 |

### Full-run accounting

| Measurement | Value |
| --- | --- |
| Full GPU-reserved wall seconds, all recorded worker attempts | 4173.44 |
...
| Checkpoint / weights / split | Images | Mud IoU (%) | Mud precision (%) | Mud recall (%) |
| --- | --- | --- | --- | --- |
| best-auto-train / raw | 220 | 93.54 | 94.73 | 98.67 |
| best-auto-val / raw | 37 | 10.41 | 14.99 | 25.43 |
| best-alternate-val / ema | 37 | 9.80 | 12.01 | 34.79 |
| final-auto-val / raw | 37 | 7.65 | 11.27 | 19.25 |
...
```json
{
  ...
  "checkpoints": {
    "best": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/smp_upernet_mit_b0--cityscapes_to_rtis--seed-1_seed1/rtis/best.ckpt",
      "sha256": "096c3704d87ae3ec7feb894f501181636d70dc5e7cf0974fbc92d399d619cf75",
      "global_step": 2800,
      "bytes": 172236854
    },
    "final": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/smp_upernet_mit_b0--cityscapes_to_rtis--seed-1_seed1/rtis/last.ckpt",
      "sha256": "18d3da38782d9decfb0ad90543c0bda2ce828b67c0db82049180d5f60f81eef6",
      "global_step": 4000,
      "bytes": 172225590
    }
  },
...
Status: **completed**. Started: 2026-09-07T11:00:08.950981+00:00. Finished: 2026-09-07T11:49:51.798481+00:00.
...
Config SHA-256: `e6d2c386ec3699c19ba2af47b44a910f52d591a493011177527ba0ccd32df5f5`. Weights used for validation: `raw`.
...
| --- | --- | --- |
| Mud IoU | 4.91 | 2.61 |
| Mud precision | 7.36 | 6.32 |
| Mud recall | 12.85 | 4.24 |
| Mud Dice/F1 | 9.36 | 5.08 |
| mIoU | 40.81 | 38.39 |
| Mean accuracy | 57.80 | 51.99 |
| Mean precision | 56.24 | 56.86 |
| Mean Dice | 51.15 | 47.44 |
| Mean specificity | 99.14 | 99.16 |
| Pixel accuracy | 86.05 | 86.69 |
| Frequency-weighted IoU | 78.37 | 78.33 |
| Fixed GT-present class mIoU | 47.62 | 44.79 |
| Boundary F1 | 48.42 | 45.41 |
...
| Peak training VRAM, retained training invocation (GiB) | 11.14 |
| Peak evaluation VRAM (GiB) | 6.22 |
| Retained training invocation wall time (seconds) | 2798.17 |
| Retained training invocation GPU-hours (one GPU) | 0.78 |
| Evaluation wall time (seconds) | 17.89 |
| Full evaluation pipeline images/second | 2.07 |
| Best full-state checkpoint (MiB) | 164.26 |
| Final full-state checkpoint (MiB) | 164.25 |
| Audited periodic checkpoints removed (GiB) | 0.80 |
...
| Status | Parameters | Weight MiB | FPS | p50 ms | p95 ms | Peak reserved GiB |
| --- | --- | --- | --- | --- | --- | --- |
| complete | 10737525 | 40.96 | 53.87 | 18.51 | 18.86 | 1.09 |

```json
{
  "schema_version": 1,
  "model_id": "smp_upernet_mit_b0",
  "measured_at": "2026-09-07T11:49:49+00:00",
  "status": "complete",
  "benchmark_scope": "rtis_selected_checkpoint_model_only",
  "applies_to": [
    "smp_upernet_mit_b0--railsem19_to_rtis--seed-2"
  ],
  "source": {
    "campaign_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "git_dirty": false,
    "config_hash": "1e13936f961f",
    "resolved_config": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/configs/smp_upernet_mit_b0--railsem19_to_rtis--seed-2.yaml",
    "config_sha256": "e6d2c386ec3699c19ba2af47b44a910f52d591a493011177527ba0ccd32df5f5",
    "checkpoint_sha256": "9c92acca52e223caf5a61c7e675eae0b02d9d5689197f963bc84d0bfea97d5bd",
    "checkpoint_global_step": 1527,
    "checkpoint_bytes": 172236854,
    "checkpoint_kind": "resume checkpoint with optimizer and EMA state",
    "weights": "raw",
    "measured_checkpoint_job_id": "smp_upernet_mit_b0--railsem19_to_rtis--seed-2",
    "result_sha256": "1e8cd9a8321f69a0520f2abd274357c6e072d24d1da0b2fc909b67acf5112e40",
    "result_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "result_stage": "eval:paul-test-rtis:val",
    "result_seed": 2
  },
  ...
  "measurements": {
    "latency": {
      "p50_ms": 18.51187229156494,
      "p95_ms": 18.85767707824707,
      "mean_ms": 18.564177684783935,
      "minimum_ms": 18.338815689086914,
      "maximum_ms": 18.99724769592285,
      "fps": 53.8671853383329,
      "raw_ms": [
        18.523136138916016,
        18.368511199951172,
        18.371583938598633,
    ...
    "peak_reserved_bytes": 1172307968,
    "memory_kind": "pytorch_cuda_allocator_peak_reserved_excluding_context",
    "benchmark_wall_clock_s": 9.592750295996666
  },
  "started_at": "2026-09-07T11:49:39+00:00",
  "finished_at": "2026-09-07T11:49:49+00:00",
  "environment": {
    "hostname": "hdrfs-app-001",
    "python": "3.11.15",
    "platform": "Linux-5.15.0-139-generic-x86_64-with-glibc2.35",
...
| Class | GT pixels | IoU (%) | Precision (%) | Recall (%) | Dice (%) | Boundary F1 (%) |
| --- | --- | --- | --- | --- | --- | --- |
| car | 29664 | 24.75 | 70.73 | 27.58 | 39.68 | 50.03 |
| construction | 311585 | 64.66 | 78.96 | 78.12 | 78.54 | 72.31 |
| fence | 265137 | 22.87 | 39.47 | 35.22 | 37.22 | 42.28 |
| mud-pumping | 1226250 | 4.91 | 7.36 | 12.85 | 9.36 | 8.13 |
| on-rails | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| person | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| pole | 628038 | 71.64 | 84.22 | 82.74 | 83.48 | 90.59 |
| rail-embedded | 16799 | 27.71 | 73.67 | 30.76 | 43.40 | 78.52 |
| rail-raised | 2969797 | 73.70 | 83.15 | 86.63 | 84.86 | 90.84 |
| rail-track | 6323197 | 48.85 | 73.19 | 59.50 | 65.64 | 60.30 |
| road | 1048831 | 19.79 | 59.55 | 22.86 | 33.04 | 30.03 |
| sidewalk | 1297367 | 45.54 | 76.91 | 52.76 | 62.58 | 12.39 |
| sky | 19121606 | 98.59 | 99.24 | 99.34 | 99.29 | 96.17 |
| standing-water | 95802 | 0.59 | 0.66 | 5.30 | 1.17 | 6.16 |
| terrain | 39239306 | 87.51 | 90.41 | 96.46 | 93.34 | 65.55 |
| trackbed | 10643081 | 66.31 | 80.75 | 78.77 | 79.75 | 62.21 |
| traffic-light | 19510 | 63.58 | 69.03 | 88.96 | 77.74 | 79.80 |
| traffic-sign | 13285 | 32.24 | 49.41 | 48.14 | 48.76 | 49.39 |
| tram-track | 56179 | 57.18 | 66.29 | 80.63 | 72.76 | 52.30 |
| truck | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| vegetation-overgrowth | 5901821 | 46.67 | 77.96 | 53.76 | 63.64 | 69.88 |

### Full-run accounting

| Measurement | Value |
| --- | --- |
| Full GPU-reserved wall seconds, all recorded worker attempts | 2982.97 |
| Full reserved GPU-hours | 0.83 |
| Whole-run timing complete | True |
...
| Checkpoint / weights / split | Images | Mud IoU (%) | Mud precision (%) | Mud recall (%) |
| --- | --- | --- | --- | --- |
| best-auto-train / raw | 220 | 93.98 | 96.38 | 97.41 |
| best-auto-val / raw | 37 | 4.91 | 7.36 | 12.85 |
| best-alternate-val / ema | 37 | 0.62 | 1.62 | 0.99 |
| final-auto-val / raw | 37 | 2.61 | 6.33 | 4.25 |
...
```json
{
  ...
  "checkpoints": {
    "best": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/smp_upernet_mit_b0--railsem19_to_rtis--seed-2_seed2/rtis/best.ckpt",
      "sha256": "9c92acca52e223caf5a61c7e675eae0b02d9d5689197f963bc84d0bfea97d5bd",
      "global_step": 1527,
      "bytes": 172236854
    },
    "final": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/smp_upernet_mit_b0--railsem19_to_rtis--seed-2_seed2/rtis/last.ckpt",
      "sha256": "5ac892e10e409c0973d4f5c0403f234fd0d67281135befb40c5bf12cc1eb5713",
      "global_step": 2800,
      "bytes": 172225718
    }
  },
...
Status: **completed**. Started: 2026-09-07T11:03:01.722249+00:00. Finished: 2026-09-07T11:48:27.800059+00:00.
...
Config SHA-256: `3adfa3f11cf93055784170b0621bd4f2f39e2d7dda817f81d97af4a75d02aebc`. Weights used for validation: `raw`.
...
| --- | --- | --- |
| Mud IoU | 21.41 | 11.98 |
| Mud precision | 37.27 | 18.11 |
| Mud recall | 33.46 | 26.13 |
| Mud Dice/F1 | 35.26 | 21.39 |
| mIoU | 36.83 | 40.50 |
| Mean accuracy | 50.21 | 53.07 |
| Mean precision | 57.78 | 59.08 |
| Mean Dice | 47.10 | 50.53 |
| Mean specificity | 99.00 | 98.96 |
| Pixel accuracy | 84.97 | 84.14 |
| Frequency-weighted IoU | 75.53 | 74.62 |
| Fixed GT-present class mIoU | 42.96 | 45.00 |
| Boundary F1 | 43.73 | 46.69 |
...
| Peak training VRAM, retained training invocation (GiB) | 11.14 |
| Peak evaluation VRAM (GiB) | 6.22 |
| Retained training invocation wall time (seconds) | 2542.70 |
| Retained training invocation GPU-hours (one GPU) | 0.71 |
| Evaluation wall time (seconds) | 17.93 |
| Full evaluation pipeline images/second | 2.06 |
| Best full-state checkpoint (MiB) | 164.26 |
| Final full-state checkpoint (MiB) | 164.25 |
| Audited periodic checkpoints removed (GiB) | 0.80 |
...
| Status | Parameters | Weight MiB | FPS | p50 ms | p95 ms | Peak reserved GiB |
| --- | --- | --- | --- | --- | --- | --- |
| complete | 10737525 | 40.96 | 54.09 | 18.41 | 18.81 | 1.09 |

```json
{
  "schema_version": 1,
  "model_id": "smp_upernet_mit_b0",
  "measured_at": "2026-09-07T11:48:24+00:00",
  "status": "complete",
  "benchmark_scope": "rtis_selected_checkpoint_model_only",
  "applies_to": [
  ...
  "source": {
    "campaign_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "git_dirty": false,
    "config_hash": "5198bcc77995",
    "resolved_config": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/configs/smp_upernet_mit_b0--cityscapes_to_railsem19_to_rtis--seed-0.yaml",
    "config_sha256": "3adfa3f11cf93055784170b0621bd4f2f39e2d7dda817f81d97af4a75d02aebc",
    "checkpoint_sha256": "f8be0473886b28d84f6126065c8ff6f6a45419b9d4c1f32fddcfa65ec4f47116",
    "checkpoint_global_step": 1272,
    "checkpoint_bytes": 172236918,
    "checkpoint_kind": "resume checkpoint with optimizer and EMA state",
    "weights": "raw",
    "measured_checkpoint_job_id": "smp_upernet_mit_b0--cityscapes_to_railsem19_to_rtis--seed-0",
    "result_sha256": "bc587bee50d9cf9da92104f04461e661c47ae724f96cdd46d7a18efa58bd6c7b",
    "result_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "result_stage": "eval:paul-test-rtis:val",
    "result_seed": 0
  },
  ...
  "measurements": {
    "latency": {
      "p50_ms": 18.4094877243042,
      "p95_ms": 18.80617036819458,
      "mean_ms": 18.486228504180907,
      "minimum_ms": 18.312192916870117,
      "maximum_ms": 19.64031982421875,
      "fps": 54.09432214763745,
      "raw_ms": [
        18.559871673583984,
        18.749439239501953,
        18.42176055908203,
    ...
    "peak_reserved_bytes": 1172307968,
    "memory_kind": "pytorch_cuda_allocator_peak_reserved_excluding_context",
    "benchmark_wall_clock_s": 9.631688464432955
  },
  "started_at": "2026-09-07T11:48:15+00:00",
  "finished_at": "2026-09-07T11:48:24+00:00",
  "environment": {
    "hostname": "hdrfs-app-001",
    "python": "3.11.15",
    "platform": "Linux-5.15.0-139-generic-x86_64-with-glibc2.35",
...
| Class | GT pixels | IoU (%) | Precision (%) | Recall (%) | Dice (%) | Boundary F1 (%) |
| --- | --- | --- | --- | --- | --- | --- |
| car | 29664 | 47.04 | 85.02 | 51.29 | 63.98 | 52.03 |
| construction | 311585 | 49.43 | 59.88 | 73.92 | 66.16 | 55.35 |
| fence | 265137 | 10.08 | 42.57 | 11.66 | 18.31 | 21.08 |
| mud-pumping | 1226250 | 21.41 | 37.27 | 33.46 | 35.26 | 24.64 |
| on-rails | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| person | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| pole | 628038 | 69.57 | 86.13 | 78.35 | 82.06 | 91.25 |
| rail-embedded | 16799 | 7.65 | 56.26 | 8.13 | 14.21 | 29.35 |
| rail-raised | 2969797 | 71.34 | 83.98 | 82.58 | 83.27 | 88.32 |
| rail-track | 6323197 | 43.51 | 68.11 | 54.64 | 60.63 | 53.69 |
| road | 1048831 | 17.83 | 36.16 | 26.02 | 30.26 | 27.67 |
| sidewalk | 1297367 | 27.82 | 81.06 | 29.76 | 43.53 | 12.71 |
| sky | 19121606 | 98.53 | 99.49 | 99.04 | 99.26 | 96.17 |
| standing-water | 95802 | 1.67 | 2.09 | 7.61 | 3.28 | 6.31 |
| terrain | 39239306 | 85.18 | 86.65 | 98.05 | 92.00 | 56.07 |
| trackbed | 10643081 | 58.59 | 75.94 | 71.95 | 73.89 | 56.08 |
| traffic-light | 19510 | 65.05 | 97.02 | 66.38 | 78.83 | 82.34 |
| traffic-sign | 13285 | 40.41 | 85.07 | 43.49 | 57.56 | 71.32 |
| tram-track | 56179 | 15.37 | 55.38 | 17.54 | 26.64 | 23.69 |
| truck | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| vegetation-overgrowth | 5901821 | 42.88 | 75.24 | 49.92 | 60.02 | 70.24 |

### Full-run accounting

| Measurement | Value |
| --- | --- |
| Full GPU-reserved wall seconds, all recorded worker attempts | 2726.27 |
| Full reserved GPU-hours | 0.76 |
| Whole-run timing complete | True |
...
| Checkpoint / weights / split | Images | Mud IoU (%) | Mud precision (%) | Mud recall (%) |
| --- | --- | --- | --- | --- |
| best-auto-train / raw | 220 | 91.90 | 93.99 | 97.65 |
| best-auto-val / raw | 37 | 21.41 | 37.27 | 33.46 |
| best-alternate-val / ema | 37 | 10.83 | 49.02 | 12.20 |
| final-auto-val / raw | 37 | 11.97 | 18.09 | 26.12 |
...
```json
{
  ...
  "checkpoints": {
    "best": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/smp_upernet_mit_b0--cityscapes_to_railsem19_to_rtis--seed-0_seed0/rtis/best.ckpt",
      "sha256": "f8be0473886b28d84f6126065c8ff6f6a45419b9d4c1f32fddcfa65ec4f47116",
      "global_step": 1272,
      "bytes": 172236918
    },
    "final": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/smp_upernet_mit_b0--cityscapes_to_railsem19_to_rtis--seed-0_seed0/rtis/last.ckpt",
      "sha256": "acd20161bc1bee531b1651cb72c6a21952a691fe30c04dd38e438a4367b9b085",
      "global_step": 2545,
      "bytes": 172225782
    }
  },
...
Status: **completed**. Started: 2026-09-07T11:08:29.376901+00:00. Finished: 2026-09-07T12:02:29.614421+00:00.
...
Config SHA-256: `922671a116367344fbeb57e29f7606ebdebb204bb6efb69714e0a3994f66ba43`. Weights used for validation: `raw`.
...
| --- | --- | --- |
| Mud IoU | 9.95 | 8.98 |
| Mud precision | 16.85 | 13.91 |
| Mud recall | 19.57 | 20.24 |
| Mud Dice/F1 | 18.11 | 16.49 |
| mIoU | 37.44 | 38.04 |
| Mean accuracy | 52.00 | 51.84 |
| Mean precision | 57.22 | 57.48 |
| Mean Dice | 46.98 | 47.66 |
| Mean specificity | 99.06 | 98.97 |
| Pixel accuracy | 85.05 | 84.18 |
| Frequency-weighted IoU | 76.46 | 74.93 |
| Fixed GT-present class mIoU | 43.69 | 44.38 |
| Boundary F1 | 43.98 | 45.85 |
...
| Peak training VRAM, retained training invocation (GiB) | 11.14 |
| Peak evaluation VRAM (GiB) | 6.22 |
| Retained training invocation wall time (seconds) | 3058.17 |
| Retained training invocation GPU-hours (one GPU) | 0.85 |
| Evaluation wall time (seconds) | 17.79 |
| Full evaluation pipeline images/second | 2.08 |
| Best full-state checkpoint (MiB) | 164.26 |
| Final full-state checkpoint (MiB) | 164.25 |
| Audited periodic checkpoints removed (GiB) | 0.96 |
...
| Status | Parameters | Weight MiB | FPS | p50 ms | p95 ms | Peak reserved GiB |
| --- | --- | --- | --- | --- | --- | --- |
| complete | 10737525 | 40.96 | 54.19 | 18.39 | 18.75 | 1.09 |

```json
{
  "schema_version": 1,
  "model_id": "smp_upernet_mit_b0",
  "measured_at": "2026-09-07T12:02:26+00:00",
  "status": "complete",
  "benchmark_scope": "rtis_selected_checkpoint_model_only",
  "applies_to": [
    "smp_upernet_mit_b0--cityscapes_to_railsem19_to_rtis--seed-1"
  ],
  "source": {
    "campaign_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "git_dirty": false,
    "config_hash": "9775a39273f6",
    "resolved_config": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/configs/smp_upernet_mit_b0--cityscapes_to_railsem19_to_rtis--seed-1.yaml",
    "config_sha256": "922671a116367344fbeb57e29f7606ebdebb204bb6efb69714e0a3994f66ba43",
    "checkpoint_sha256": "a288134bdbd7a43a8b50e1c3453c665e15dd7e94ef950f74b507fe87d93c1761",
    "checkpoint_global_step": 1781,
    "checkpoint_bytes": 172236918,
    "checkpoint_kind": "resume checkpoint with optimizer and EMA state",
    "weights": "raw",
    "measured_checkpoint_job_id": "smp_upernet_mit_b0--cityscapes_to_railsem19_to_rtis--seed-1",
    "result_sha256": "d313cc6415792b848f4d21bea7b63472478f92c5d6564bc8af300c5bd875ccf1",
    "result_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "result_stage": "eval:paul-test-rtis:val",
    "result_seed": 1
  },
  ...
  "measurements": {
    "latency": {
      "p50_ms": 18.3920316696167,
      "p95_ms": 18.74575834274292,
      "mean_ms": 18.453458271026612,
      "minimum_ms": 18.323455810546875,
      "maximum_ms": 19.06073570251465,
      "fps": 54.19038455085023,
      "raw_ms": [
        18.720767974853516,
        18.374656677246094,
        18.35820770263672,
    ...
    "peak_reserved_bytes": 1172307968,
    "memory_kind": "pytorch_cuda_allocator_peak_reserved_excluding_context",
    "benchmark_wall_clock_s": 9.260826975107193
  },
  "started_at": "2026-09-07T12:02:17+00:00",
  "finished_at": "2026-09-07T12:02:26+00:00",
  "environment": {
    "hostname": "hdrfs-app-001",
    "python": "3.11.15",
    "platform": "Linux-5.15.0-139-generic-x86_64-with-glibc2.35",
...
| Class | GT pixels | IoU (%) | Precision (%) | Recall (%) | Dice (%) | Boundary F1 (%) |
| --- | --- | --- | --- | --- | --- | --- |
| car | 29664 | 61.79 | 83.82 | 70.16 | 76.39 | 62.16 |
| construction | 311585 | 46.14 | 53.42 | 77.20 | 63.14 | 47.45 |
| fence | 265137 | 14.04 | 32.30 | 19.89 | 24.62 | 30.49 |
| mud-pumping | 1226250 | 9.95 | 16.85 | 19.57 | 18.11 | 10.61 |
| on-rails | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| person | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| pole | 628038 | 71.25 | 87.63 | 79.22 | 83.21 | 92.17 |
| rail-embedded | 16799 | 2.16 | 76.25 | 2.18 | 4.24 | 18.43 |
| rail-raised | 2969797 | 75.16 | 85.87 | 85.76 | 85.82 | 90.65 |
| rail-track | 6323197 | 41.81 | 69.37 | 51.27 | 58.96 | 56.45 |
| road | 1048831 | 13.20 | 31.18 | 18.62 | 23.32 | 24.68 |
| sidewalk | 1297367 | 44.66 | 85.80 | 48.23 | 61.75 | 20.58 |
| sky | 19121606 | 98.52 | 99.19 | 99.32 | 99.25 | 96.83 |
| standing-water | 95802 | 0.38 | 0.46 | 2.09 | 0.75 | 2.11 |
| terrain | 39239306 | 87.97 | 89.70 | 97.85 | 93.60 | 62.18 |
| trackbed | 10643081 | 55.17 | 68.12 | 74.38 | 71.11 | 53.84 |
| traffic-light | 19510 | 69.04 | 77.33 | 86.57 | 81.69 | 78.96 |
| traffic-sign | 13285 | 35.64 | 81.41 | 38.80 | 52.55 | 63.36 |
| tram-track | 56179 | 15.64 | 81.32 | 16.22 | 27.04 | 40.14 |
| truck | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| vegetation-overgrowth | 5901821 | 43.83 | 81.60 | 48.63 | 60.95 | 72.51 |

### Full-run accounting

| Measurement | Value |
| --- | --- |
| Full GPU-reserved wall seconds, all recorded worker attempts | 3240.38 |
...
| Checkpoint / weights / split | Images | Mud IoU (%) | Mud precision (%) | Mud recall (%) |
| --- | --- | --- | --- | --- |
| best-auto-train / raw | 220 | 94.48 | 97.10 | 97.22 |
| best-auto-val / raw | 37 | 9.95 | 16.85 | 19.57 |
| best-alternate-val / ema | 37 | 7.54 | 20.03 | 10.79 |
| final-auto-val / raw | 37 | 8.99 | 13.92 | 20.25 |
...
```json
{
  ...
  "checkpoints": {
    "best": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/smp_upernet_mit_b0--cityscapes_to_railsem19_to_rtis--seed-1_seed1/rtis/best.ckpt",
      "sha256": "a288134bdbd7a43a8b50e1c3453c665e15dd7e94ef950f74b507fe87d93c1761",
      "global_step": 1781,
      "bytes": 172236918
    },
    "final": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/smp_upernet_mit_b0--cityscapes_to_railsem19_to_rtis--seed-1_seed1/rtis/last.ckpt",
      "sha256": "6515de95cdfe9e031210a9f74ffcc903e31bf7a2590cd0ccdf06722bb55ab5b8",
      "global_step": 3054,
      "bytes": 172225782
    }
  },
...
Status: **completed**. Started: 2026-09-07T11:13:07.878951+00:00. Finished: 2026-09-07T12:02:57.396634+00:00.
...
Config SHA-256: `caae87225cada66e1f0ca41761d57a085772a25310ea5f5be2ccc1d2107b9b26`. Weights used for validation: `raw`.
...
| --- | --- | --- |
| Mud IoU | 13.15 | 11.01 |
| Mud precision | 26.02 | 31.06 |
| Mud recall | 21.01 | 14.57 |
| Mud Dice/F1 | 23.25 | 19.83 |
| mIoU | 38.24 | 35.85 |
| Mean accuracy | 54.54 | 49.98 |
| Mean precision | 57.58 | 58.83 |
| Mean Dice | 48.97 | 45.73 |
| Mean specificity | 98.98 | 98.94 |
| Pixel accuracy | 83.93 | 83.82 |
| Frequency-weighted IoU | 74.68 | 73.83 |
| Fixed GT-present class mIoU | 44.61 | 41.83 |
| Boundary F1 | 44.86 | 42.38 |
...
| Peak training VRAM, retained training invocation (GiB) | 11.14 |
| Peak evaluation VRAM (GiB) | 6.22 |
| Retained training invocation wall time (seconds) | 2806.40 |
| Retained training invocation GPU-hours (one GPU) | 0.78 |
| Evaluation wall time (seconds) | 17.85 |
| Full evaluation pipeline images/second | 2.07 |
| Best full-state checkpoint (MiB) | 164.26 |
| Final full-state checkpoint (MiB) | 164.25 |
| Audited periodic checkpoints removed (GiB) | 0.80 |
...
| Status | Parameters | Weight MiB | FPS | p50 ms | p95 ms | Peak reserved GiB |
| --- | --- | --- | --- | --- | --- | --- |
| complete | 10737525 | 40.96 | 54.12 | 18.43 | 18.73 | 1.09 |

```json
{
  "schema_version": 1,
  "model_id": "smp_upernet_mit_b0",
  "measured_at": "2026-09-07T12:02:54+00:00",
  "status": "complete",
  "benchmark_scope": "rtis_selected_checkpoint_model_only",
  "applies_to": [
    "smp_upernet_mit_b0--cityscapes_to_railsem19_to_rtis--seed-2"
  ],
  "source": {
    "campaign_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "git_dirty": false,
    "config_hash": "2e027209d8d6",
    "resolved_config": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/configs/smp_upernet_mit_b0--cityscapes_to_railsem19_to_rtis--seed-2.yaml",
    "config_sha256": "caae87225cada66e1f0ca41761d57a085772a25310ea5f5be2ccc1d2107b9b26",
    "checkpoint_sha256": "381a220197cf43ce663367aef53f5b476621ddd19da6be73581bba98926c7ac6",
    "checkpoint_global_step": 1527,
    "checkpoint_bytes": 172236918,
    "checkpoint_kind": "resume checkpoint with optimizer and EMA state",
    "weights": "raw",
    "measured_checkpoint_job_id": "smp_upernet_mit_b0--cityscapes_to_railsem19_to_rtis--seed-2",
    "result_sha256": "2e839c3cbf1f130715784cbca1dac22f4c9e8cdb0c908fadc04bca0a00a646f4",
    "result_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "result_stage": "eval:paul-test-rtis:val",
    "result_seed": 2
  },
  ...
  "measurements": {
    "latency": {
      "p50_ms": 18.43046474456787,
      "p95_ms": 18.73117208480835,
      "mean_ms": 18.476785316467286,
      "minimum_ms": 18.338815689086914,
      "maximum_ms": 19.007488250732422,
      "fps": 54.12196888539686,
      "raw_ms": [
        18.59993553161621,
        18.472959518432617,
        18.384864807128906,
    ...
    "peak_reserved_bytes": 1172307968,
    "memory_kind": "pytorch_cuda_allocator_peak_reserved_excluding_context",
    "benchmark_wall_clock_s": 9.402330186218023
  },
  "started_at": "2026-09-07T12:02:45+00:00",
  "finished_at": "2026-09-07T12:02:54+00:00",
  "environment": {
    "hostname": "hdrfs-app-001",
    "python": "3.11.15",
    "platform": "Linux-5.15.0-139-generic-x86_64-with-glibc2.35",
...
| Class | GT pixels | IoU (%) | Precision (%) | Recall (%) | Dice (%) | Boundary F1 (%) |
| --- | --- | --- | --- | --- | --- | --- |
| car | 29664 | 53.89 | 80.37 | 62.07 | 70.04 | 52.74 |
| construction | 311585 | 35.47 | 40.57 | 73.85 | 52.37 | 35.59 |
| fence | 265137 | 14.40 | 41.25 | 18.11 | 25.17 | 33.65 |
| mud-pumping | 1226250 | 13.15 | 26.02 | 21.01 | 23.25 | 15.74 |
| on-rails | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| person | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| pole | 628038 | 72.26 | 86.03 | 81.86 | 83.89 | 91.38 |
| rail-embedded | 16799 | 17.04 | 78.53 | 17.88 | 29.12 | 55.37 |
| rail-raised | 2969797 | 65.80 | 86.24 | 73.52 | 79.38 | 86.37 |
| rail-track | 6323197 | 40.05 | 65.99 | 50.47 | 57.19 | 53.22 |
| road | 1048831 | 22.59 | 51.03 | 28.84 | 36.85 | 30.49 |
| sidewalk | 1297367 | 44.71 | 93.98 | 46.02 | 61.79 | 13.82 |
| sky | 19121606 | 98.44 | 99.22 | 99.22 | 99.22 | 96.05 |
| standing-water | 95802 | 2.67 | 2.97 | 20.84 | 5.21 | 12.18 |
| terrain | 39239306 | 86.16 | 88.31 | 97.26 | 92.57 | 58.71 |
| trackbed | 10643081 | 51.39 | 63.77 | 72.57 | 67.89 | 53.71 |
| traffic-light | 19510 | 77.46 | 87.66 | 86.95 | 87.30 | 91.24 |
| traffic-sign | 13285 | 41.15 | 57.65 | 58.98 | 58.30 | 59.40 |
| tram-track | 56179 | 25.75 | 76.15 | 28.01 | 40.96 | 32.64 |
| truck | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| vegetation-overgrowth | 5901821 | 40.61 | 83.36 | 44.20 | 57.77 | 69.88 |

### Full-run accounting

| Measurement | Value |
| --- | --- |
| Full GPU-reserved wall seconds, all recorded worker attempts | 2989.65 |
| Full reserved GPU-hours | 0.83 |
| Whole-run timing complete | True |
...
| Checkpoint / weights / split | Images | Mud IoU (%) | Mud precision (%) | Mud recall (%) |
| --- | --- | --- | --- | --- |
| best-auto-train / raw | 220 | 91.92 | 93.16 | 98.57 |
| best-auto-val / raw | 37 | 13.15 | 26.02 | 21.01 |
| best-alternate-val / ema | 37 | 7.46 | 16.11 | 12.21 |
| final-auto-val / raw | 37 | 10.99 | 30.95 | 14.56 |
...
```json
{
  ...
  "checkpoints": {
    "best": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/smp_upernet_mit_b0--cityscapes_to_railsem19_to_rtis--seed-2_seed2/rtis/best.ckpt",
      "sha256": "381a220197cf43ce663367aef53f5b476621ddd19da6be73581bba98926c7ac6",
      "global_step": 1527,
      "bytes": 172236918
    },
    "final": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/smp_upernet_mit_b0--cityscapes_to_railsem19_to_rtis--seed-2_seed2/rtis/last.ckpt",
      "sha256": "edf914d6c68e51e1dc6126eab13c5262b8b498f3466c803ffec15831c3eb7e2c",
      "global_step": 2800,
      "bytes": 172225782
    }
  },
