...
| native_resnet101_uper | cityscapes_to_rtis | 0 | completed | 4000 | 2800 | 0.79 | 1.86 | 1.36 | 0.50 | 32.59 | 38.02 |
...
| native_resnet101_uper | railsem19_to_rtis | 2 | completed | 2290 | 1018 | 0.97 | 1.83 | 2.03 | 0.76 | 42.05 | 49.06 |
...
Status: **completed**. Started: 2026-09-06T20:34:46.981153+00:00. Finished: 2026-09-06T21:38:43.916871+00:00.
...
Config SHA-256: `a551308f71ab720d18ed53c709b7b3bb7169430273d68a61230577c303b5e2ce`. Weights used for validation: `raw`.
...
| --- | --- | --- |
| Mud IoU | 0.79 | 0.50 |
| Mud precision | 1.86 | 1.41 |
| Mud recall | 1.36 | 0.76 |
| Mud Dice/F1 | 1.57 | 0.99 |
| mIoU | 32.59 | 31.02 |
| Mean accuracy | 47.88 | 45.53 |
| Mean precision | 49.74 | 48.64 |
| Mean Dice | 42.00 | 39.65 |
| Mean specificity | 98.80 | 98.73 |
| Pixel accuracy | 82.15 | 81.71 |
| Frequency-weighted IoU | 71.00 | 70.09 |
| Fixed GT-present class mIoU | 38.02 | 36.19 |
| Boundary F1 | 37.40 | 36.64 |
...
| Peak training VRAM, retained training invocation (GiB) | 10.87 |
| Peak evaluation VRAM (GiB) | 7.54 |
| Retained training invocation wall time (seconds) | 3652.82 |
...
| Best full-state checkpoint (MiB) | 937.27 |
| Final full-state checkpoint (MiB) | 937.24 |
| Audited periodic checkpoints removed (GiB) | 7.32 |
...
| Status | Parameters | Weight MiB | FPS | p50 ms | p95 ms | Peak reserved GiB |
| --- | --- | --- | --- | --- | --- | --- |
| complete | 61323093 | 233.93 | 62.94 | 15.58 | 19.18 | 1.31 |

```json
{
  "schema_version": 1,
  "model_id": "native_resnet101_uper",
  "measured_at": "2026-09-06T21:38:32+00:00",
  "status": "complete",
  "benchmark_scope": "rtis_selected_checkpoint_model_only",
  "applies_to": [
  ...
  "source": {
    "campaign_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "git_dirty": false,
    "config_hash": "94f7096a2c38",
    "resolved_config": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/configs/native_resnet101_uper--cityscapes_to_rtis--seed-0.yaml",
    "config_sha256": "a551308f71ab720d18ed53c709b7b3bb7169430273d68a61230577c303b5e2ce",
    "checkpoint_sha256": "b0da4a60f6a131669a3b1000340f148a0f74162d2db0e9157973c62106da3356",
    "checkpoint_global_step": 2800,
    "checkpoint_bytes": 982793855,
    "checkpoint_kind": "resume checkpoint with optimizer and EMA state",
    "weights": "raw",
    "measured_checkpoint_job_id": "native_resnet101_uper--cityscapes_to_rtis--seed-0",
    "result_sha256": "73362bb3c0a08f749665f8851a82274391c86a8bc8bd459c17351e32f521957c",
    "result_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "result_stage": "eval:paul-test-rtis:val",
    "result_seed": 0
  },
  ...
  "measurements": {
    "latency": {
      "p50_ms": 15.583231925964355,
      "p95_ms": 19.181158161163328,
      "mean_ms": 15.888813428878784,
      "minimum_ms": 14.899200439453125,
      "maximum_ms": 21.25619125366211,
      "fps": 62.937361841158356,
      "raw_ms": [
        16.24883270263672,
        15.440863609313965,
        15.310848236083984,
    ...
    "peak_reserved_bytes": 1405091840,
    "memory_kind": "pytorch_cuda_allocator_peak_reserved_excluding_context",
    "benchmark_wall_clock_s": 15.192762315273285
  },
  "started_at": "2026-09-06T21:38:17+00:00",
  "finished_at": "2026-09-06T21:38:32+00:00",
  "environment": {
    "hostname": "hdrfs-app-001",
    "python": "3.11.15",
    "platform": "Linux-5.15.0-139-generic-x86_64-with-glibc2.35",
...
| Class | GT pixels | IoU (%) | Precision (%) | Recall (%) | Dice (%) | Boundary F1 (%) |
| --- | --- | --- | --- | --- | --- | --- |
| car | 29664 | 61.66 | 72.33 | 80.70 | 76.29 | 52.38 |
| construction | 311585 | 33.61 | 41.15 | 64.74 | 50.31 | 45.29 |
| fence | 265137 | 22.74 | 35.86 | 38.33 | 37.05 | 33.28 |
| mud-pumping | 1226250 | 0.79 | 1.86 | 1.36 | 1.57 | 2.56 |
| on-rails | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| person | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| pole | 628038 | 72.33 | 81.68 | 86.33 | 83.94 | 90.81 |
| rail-embedded | 16799 | 18.93 | 62.30 | 21.38 | 31.84 | 20.02 |
| rail-raised | 2969797 | 72.38 | 78.54 | 90.23 | 83.98 | 87.22 |
| rail-track | 6323197 | 34.58 | 67.71 | 41.41 | 51.39 | 46.53 |
| road | 1048831 | 14.11 | 31.97 | 20.17 | 24.74 | 22.17 |
| sidewalk | 1297367 | 12.60 | 45.33 | 14.85 | 22.38 | 6.69 |
| sky | 19121606 | 98.16 | 99.34 | 98.80 | 99.07 | 93.57 |
| standing-water | 95802 | 2.50 | 6.06 | 4.09 | 4.88 | 7.12 |
| terrain | 39239306 | 82.57 | 83.76 | 98.31 | 90.46 | 58.95 |
| trackbed | 10643081 | 58.75 | 68.37 | 80.68 | 74.01 | 55.68 |
| traffic-light | 19510 | 38.93 | 86.16 | 41.53 | 56.05 | 62.16 |
| traffic-sign | 13285 | 38.28 | 55.60 | 55.13 | 55.37 | 58.19 |
| tram-track | 56179 | 11.35 | 42.13 | 13.45 | 20.39 | 4.80 |
| truck | 0 | 0.00 | 0.00 | — | 0.00 | 0.00 |
| vegetation-overgrowth | 5901821 | 10.09 | 84.34 | 10.28 | 18.33 | 38.06 |

### Full-run accounting

| Measurement | Value |
| --- | --- |
| Full GPU-reserved wall seconds, all recorded worker attempts | 3837.72 |
...
| Checkpoint / weights / split | Images | Mud IoU (%) | Mud precision (%) | Mud recall (%) |
| --- | --- | --- | --- | --- |
| best-auto-train / raw | 220 | 94.77 | 98.03 | 96.61 |
| best-auto-val / raw | 37 | 0.79 | 1.86 | 1.36 |
| best-alternate-val / ema | 37 | 0.36 | 0.62 | 0.87 |
| final-auto-val / raw | 37 | 0.49 | 1.41 | 0.76 |
...
```json
{
  ...
  "checkpoints": {
    "best": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/native_resnet101_uper--cityscapes_to_rtis--seed-0_seed0/rtis/best.ckpt",
      "sha256": "b0da4a60f6a131669a3b1000340f148a0f74162d2db0e9157973c62106da3356",
      "global_step": 2800,
      "bytes": 982793855
    },
    "final": {
      "path": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/future-runs/native_resnet101_uper--cityscapes_to_rtis--seed-0_seed0/rtis/last.ckpt",
      "sha256": "905f8f92b3a1b1a1a67b67990e2d08433e22be91ca69e884cc8300cd3775684c",
      "global_step": 4000,
      "bytes": 982771647
    }
  },
...
Status: **completed**. Started: 2026-09-06T20:50:42.670738+00:00. Finished: 2026-09-06T21:29:24.580772+00:00.
...
| Status | Parameters | Weight MiB | FPS | p50 ms | p95 ms | Peak reserved GiB |
| --- | --- | --- | --- | --- | --- | --- |
| complete | 61323093 | 233.93 | 63.89 | 15.46 | 16.91 | 1.36 |

```json
{
  "schema_version": 1,
  "model_id": "native_resnet101_uper",
  "measured_at": "2026-09-06T21:29:17+00:00",
  "status": "complete",
  "benchmark_scope": "rtis_selected_checkpoint_model_only",
  "applies_to": [
    "native_resnet101_uper--railsem19_to_rtis--seed-2"
  ],
  "source": {
    "campaign_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "git_dirty": false,
    "config_hash": "d783e3dab493",
    "resolved_config": "/data/izadia1/projects/segmentary-runs/paul-test-rtis/mud-fullstats-v1-20260906-r2/configs/native_resnet101_uper--railsem19_to_rtis--seed-2.yaml",
    "config_sha256": "6eef767fd8790f55b06d9e30e80308cba6914a69fb773bebfcc98bd5dd447262",
    "checkpoint_sha256": "e3b0a7b7af8187b2e65a4ec73614d5edc6c693a3d382d6ff17e2b5995683801d",
    "checkpoint_global_step": 1018,
    "checkpoint_bytes": 982793855,
    "checkpoint_kind": "resume checkpoint with optimizer and EMA state",
    "weights": "raw",
    "measured_checkpoint_job_id": "native_resnet101_uper--railsem19_to_rtis--seed-2",
    "result_sha256": "6c2391352826999ccbb178e3aa4a8326df6c3be391b6ce6ed8102435073a8a02",
    "result_git_sha": "066afb2626398b7be59d4d19f5a0e4644fd59adc",
    "result_stage": "eval:paul-test-rtis:val",
    "result_seed": 2
  },
  ...
  "measurements": {
    "latency": {
      "p50_ms": 15.458816051483154,
      "p95_ms": 16.909157943725585,
      "mean_ms": 15.651408624649047,
      "minimum_ms": 14.766079902648926,
      "maximum_ms": 17.969152450561523,
      "fps": 63.89201278823701,
      "raw_ms": [
        17.092607498168945,
        15.512543678283691,
        15.545344352722168,
    ...
    "peak_reserved_bytes": 1461714944,
    "memory_kind": "pytorch_cuda_allocator_peak_reserved_excluding_context",
    "benchmark_wall_clock_s": 15.342043995857239
  },
  "started_at": "2026-09-06T21:29:02+00:00",
  "finished_at": "2026-09-06T21:29:17+00:00",
  "environment": {
    "hostname": "hdrfs-app-001",
    "python": "3.11.15",
    "platform": "Linux-5.15.0-139-generic-x86_64-with-glibc2.35",
...
| Measurement | Value |
| --- | --- |
| Full GPU-reserved wall seconds, all recorded worker attempts | 2322.60 |
...
| Checkpoint / weights / split | Images | Mud IoU (%) | Mud precision (%) | Mud recall (%) |
| --- | --- | --- | --- | --- |
| best-auto-train / raw | 220 | 94.57 | 96.64 | 97.79 |
| best-auto-val / raw | 37 | 0.97 | 1.83 | 2.03 |
| best-alternate-val / ema | 37 | 0.41 | 0.91 | 0.75 |
| final-auto-val / raw | 37 | 0.76 | 1.42 | 1.61 |
